...
public final class MediaBrowserCompat {
    ...
    static class MediaBrowserImplApi21 implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl, ConnectionCallback.ConnectionCallbackInternal {
        ...
        private final C3191a<String, Subscription> mSubscriptions = new C3191a<>();
        ...
        public void onConnected() {
            ...
            if (extras != null) {
                ...
                IBinder a = C0709d.m2213a(extras, "extra_messenger");
                if (a != null) {
                ...
                IMediaSession asInterface = IMediaSession.Stub.asInterface(C0709d.m2213a(extras, "extra_session_binder"));
                if (asInterface != null) {
    ...
    private static class ServiceBinderWrapper {
        ...
        public void addSubscription(String str, IBinder iBinder, Bundle bundle, Messenger messenger) throws RemoteException {
            ...
            C0709d.m2214a(bundle2, "data_callback_token", iBinder);
        ...
        public void removeSubscription(String str, IBinder iBinder, Messenger messenger) throws RemoteException {
            Bundle bundle = new Bundle();
            bundle.putString("data_media_item_id", str);
            C0709d.m2214a(bundle, "data_callback_token", iBinder);
    ...
    private static class Subscription {
        ...
        public SubscriptionCallback getCallback(Bundle bundle) {
            for (int i = 0; i < this.mOptionsList.size(); i++) {
                if (C1012d.m3565a(this.mOptionsList.get(i), bundle)) {
