...
public final class MediaControllerCompat {
    ...
    private static class MediaControllerExtraData extends C0711e.C0712a {
    ...
    public static MediaControllerCompat getMediaController(Activity activity) {
        ...
        if (activity instanceof C0711e) {
            MediaControllerExtraData mediaControllerExtraData = (MediaControllerExtraData) ((C0711e) activity).getExtraData(MediaControllerExtraData.class);
    ...
    public static void setMediaController(Activity activity, MediaControllerCompat mediaControllerCompat) {
        if (activity instanceof C0711e) {
            ((C0711e) activity).putExtraData(new MediaControllerExtraData(mediaControllerCompat));
        }
        if (Build.VERSION.SDK_INT >= 21) {
            Object obj = null;
            ...
            public void onReceiveResult(int i, Bundle bundle) {
                ...
                if (mediaControllerImplApi21 != null && bundle != null) {
                    synchronized (mediaControllerImplApi21.mLock) {
                        mediaControllerImplApi21.mSessionToken.setExtraBinder(IMediaSession.Stub.asInterface(C0709d.m2213a(bundle, MediaSessionCompat.KEY_EXTRA_BINDER)));
