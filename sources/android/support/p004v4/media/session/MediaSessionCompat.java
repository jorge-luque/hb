...
import androidx.media.C1013e;
import androidx.media.C1017i;
import androidx.media.p027j.C1019a;
...
public class MediaSessionCompat {
    ...
    public static abstract class Callback {
        ...
        private class CallbackHandler extends Handler {
            ...
            public void handleMessage(Message message) {
                if (message.what == 1) {
                    Callback.this.handleMediaPlayPauseKeySingleTapIfPending((C1013e) message.obj);
                }
            }
        }
        ...
        private class StubApi21 implements MediaSessionCompatApi21.Callback {
            ...
            public void onCommand(java.lang.String r5, android.os.Bundle r6, android.os.ResultReceiver r7) {
                /*
                    ...
                    android.support.v4.media.session.MediaSessionCompat$Callback r5 = android.support.p004v4.media.session.MediaSessionCompat.Callback.this     // Catch:{ BadParcelableException -> 0x00c4 }
                    ...
                    android.support.v4.media.session.MediaSessionCompat$MediaSessionImplApi21 r5 = (android.support.p004v4.media.session.MediaSessionCompat.MediaSessionImplApi21) r5     // Catch:{ BadParcelableException -> 0x00c4 }
                ...
                L_0x002b:
                    androidx.core.app.C0709d.m2214a(r6, r2, r1)     // Catch:{ BadParcelableException -> 0x00c4 }
                ...
                L_0x003d:
                    ...
                    android.support.v4.media.MediaDescriptionCompat r6 = (android.support.p004v4.media.MediaDescriptionCompat) r6     // Catch:{ BadParcelableException -> 0x00c4 }
                ...
                L_0x0054:
                    ...
                    android.support.v4.media.MediaDescriptionCompat r7 = (android.support.p004v4.media.MediaDescriptionCompat) r7     // Catch:{ BadParcelableException -> 0x00c4 }
                ...
                L_0x0082:
                    ...
                    r1 = r5
                    android.support.v4.media.session.MediaSessionCompat$QueueItem r1 = (android.support.p004v4.media.session.MediaSessionCompat.QueueItem) r1     // Catch:{ BadParcelableException -> 0x00c4 }
                L_0x00b2:
                    ...
                    goto L_0x00cb
                L_0x00be:
                    android.support.v4.media.session.MediaSessionCompat$Callback r0 = android.support.p004v4.media.session.MediaSessionCompat.Callback.this     // Catch:{ BadParcelableException -> 0x00c4 }
        ...
        public void handleMediaPlayPauseKeySingleTapIfPending(C1013e eVar) {
            long j;
            if (this.mMediaPlayPauseKeyPending) {
                ...
                if (mediaSessionImpl != null) {
                    ...
                    mediaSessionImpl.setCurrentControllerInfo((C1013e) null);
                }
            }
        }
        ...
        public boolean onMediaButtonEvent(Intent intent) {
            ...
            C1013e currentControllerInfo = mediaSessionImpl.getCurrentControllerInfo();
    ...
    interface MediaSessionImpl {
        ...
        C1013e getCurrentControllerInfo();
        ...
        void setCurrentControllerInfo(C1013e eVar);
        ...
        void setPlaybackToRemote(C1017i iVar);
    ...
    static class MediaSessionImplApi28 extends MediaSessionImplApi21 {
        ...
        public final C1013e getCurrentControllerInfo() {
            return new C1013e(((MediaSession) this.mSessionObj).getCurrentControllerInfo());
        }

        public void setCurrentControllerInfo(C1013e eVar) {
        }
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        private C1013e mRemoteUserInfo;
        int mRepeatMode;
        ...
        private C1017i.C1018a mVolumeCallback = new C1017i.C1018a() {
            public void onVolumeChanged(C1017i iVar) {
                if (MediaSessionImplBase.this.mVolumeProvider == iVar) {
                    MediaSessionImplBase mediaSessionImplBase = MediaSessionImplBase.this;
                    MediaSessionImplBase.this.sendVolumeInfoChanged(new ParcelableVolumeInfo(mediaSessionImplBase.mVolumeType, mediaSessionImplBase.mLocalStream, iVar.mo5130c(), iVar.mo5128b(), iVar.mo5125a()));
                }
            }
        };
        C1017i mVolumeProvider;
        int mVolumeType;
        ...
        class MediaSessionStub extends IMediaSession.Stub {
            ...
            public ParcelableVolumeInfo getVolumeAttributes() {
                ...
                synchronized (MediaSessionImplBase.this.mLock) {
                    ...
                    C1017i iVar = MediaSessionImplBase.this.mVolumeProvider;
                    if (i == 2) {
                        int c = iVar.mo5130c();
                        int b = iVar.mo5128b();
                        i3 = iVar.mo5125a();
            ...
            public void registerCallbackListener(IMediaControllerCallback iMediaControllerCallback) {
                if (MediaSessionImplBase.this.mDestroyed) {
                    ...
                    MediaSessionImplBase.this.mControllerCallbacks.register(iMediaControllerCallback, new C1013e("android.media.session.MediaController", Binder.getCallingPid(), Binder.getCallingUid()));
                }
            }
        ...
        class MessageHandler extends Handler {
            ...
            public void handleMessage(Message message) {
                ...
                if (callback != null) {
                    ...
                    MediaSessionImplBase.this.setCurrentControllerInfo(new C1013e(data.getString(MediaSessionCompat.DATA_CALLING_PACKAGE), data.getInt(MediaSessionCompat.DATA_CALLING_PID), data.getInt(MediaSessionCompat.DATA_CALLING_UID)));
                    ...
                    try {
                        ...
                        MediaSessionImplBase.this.setCurrentControllerInfo((C1013e) null);
                    }
                }
            }
        }
        ...
        public void adjustVolume(int i, int i2) {
            if (this.mVolumeType == 2) {
                C1017i iVar = this.mVolumeProvider;
                if (iVar != null) {
                    iVar.mo5126a(i);
                    return;
                }
        ...
        public C1013e getCurrentControllerInfo() {
            C1013e eVar;
        ...
        public int getRccTransportControlFlagsFromActions(long j) {
            ...
            if ((32 & j) != 0) {
                i |= OguryChoiceManager.TcfV2.Purpose.MEASURE_AD_PERFORMANCE;
            }
            if ((64 & j) != 0) {
                i |= 64;
            }
        ...
        public void setPlaybackToLocal(int i) {
            C1017i iVar = this.mVolumeProvider;
            if (iVar != null) {
                iVar.mo5127a((C1017i.C1018a) null);
            }
            this.mLocalStream = i;
            this.mVolumeType = 1;
        ...
        public void setPlaybackToRemote(C1017i iVar) {
            if (iVar != null) {
                C1017i iVar2 = this.mVolumeProvider;
                if (iVar2 != null) {
                    iVar2.mo5127a((C1017i.C1018a) null);
                }
                this.mVolumeType = 2;
                this.mVolumeProvider = iVar;
                sendVolumeInfoChanged(new ParcelableVolumeInfo(this.mVolumeType, this.mLocalStream, this.mVolumeProvider.mo5130c(), this.mVolumeProvider.mo5128b(), this.mVolumeProvider.mo5125a()));
                iVar.mo5127a(this.mVolumeCallback);
                return;
            }
    ...
    public static final class Token implements Parcelable {
        ...
        public static Token fromBundle(Bundle bundle) {
            ...
            IMediaSession asInterface = IMediaSession.Stub.asInterface(C0709d.m2213a(bundle, MediaSessionCompat.KEY_EXTRA_BINDER));
        ...
        public Bundle toBundle() {
            ...
            if (iMediaSession != null) {
                C0709d.m2214a(bundle, MediaSessionCompat.KEY_EXTRA_BINDER, iMediaSession.asBinder());
            }
    ...
    private MediaSessionCompat(Context context, String str, ComponentName componentName, PendingIntent pendingIntent, Bundle bundle) {
        ...
        if (context == null) {
            ...
            if (componentName == null && (componentName = C1019a.m3573a(context)) == null) {
    ...
    static class MediaSessionImplApi21 implements MediaSessionImpl {
        ...
        class ExtraSession extends IMediaSession.Stub {
            ...
            public void registerCallbackListener(IMediaControllerCallback iMediaControllerCallback) {
                ...
                if (!mediaSessionImplApi21.mDestroyed) {
                    ...
                    MediaSessionImplApi21.this.mExtraControllerCallbacks.register(iMediaControllerCallback, new C1013e(callingPackage, Binder.getCallingPid(), Binder.getCallingUid()));
                }
            }
        ...
        public void setPlaybackToRemote(C1017i iVar) {
            MediaSessionCompatApi21.setPlaybackToRemote(this.mSessionObj, iVar.mo5131d());
        }
