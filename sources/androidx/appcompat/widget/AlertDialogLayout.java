...
public class AlertDialogLayout extends LinearLayoutCompat {
    ...
    /* renamed from: a */
    private void m1170a(View view, int i, int i2, int i3, int i4) {
        view.layout(i, i2, i3 + i, i4 + i2);
    }

    /* renamed from: c */
    private void m1172c(int i, int i2) {
        int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(getMeasuredWidth(), 1073741824);
        for (int i3 = 0; i3 < i; i3++) {
            View childAt = getChildAt(i3);
            if (childAt.getVisibility() != 8) {
                LinearLayoutCompat.C0537a aVar = (LinearLayoutCompat.C0537a) childAt.getLayoutParams();
                if (aVar.width == -1) {
                    int i4 = aVar.height;
    ...
    /* renamed from: d */
    private boolean m1173d(int i, int i2) {
        int i3;
        int i4;
        int i5;
        int i6;
    ...
    public void onLayout(boolean r18, int r19, int r20, int r21, int r22) {
        ...
        L_0x0040:
            ...
            int r0 = r1 + r2
        L_0x004b:
            android.graphics.drawable.Drawable r1 = r17.mo3146c()
            r2 = 0
        ...
        L_0x005a:
            ...
            r15 = r2
            androidx.appcompat.widget.LinearLayoutCompat$a r15 = (androidx.appcompat.widget.LinearLayoutCompat.C0537a) r15
            int r2 = r15.f1136b
            if (r2 >= 0) goto L_0x007e
            r2 = r11
        L_0x007e:
            int r3 = androidx.core.p020f.C0839t.m2725n(r17)
            int r2 = androidx.core.p020f.C0804c.m2545a(r2, r3)
            r2 = r2 & 7
            r3 = 1
    ...
    /* renamed from: c */
    private static int m1171c(View view) {
        int o = C0839t.m2726o(view);
        if (o > 0) {
            return o;
        }
        if (view instanceof ViewGroup) {
            ...
            if (viewGroup.getChildCount() == 1) {
                return m1171c(viewGroup.getChildAt(0));
            }
        }
        return 0;
    }
