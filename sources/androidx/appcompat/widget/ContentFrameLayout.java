...
public class ContentFrameLayout extends FrameLayout {
    ...
    /* renamed from: g */
    private final Rect f1116g;

    /* renamed from: h */
    private C0536a f1117h;
    ...
    /* renamed from: a */
    public void mo3116a(Rect rect) {
        fitSystemWindows(rect);
    }

    /* renamed from: b */
    public TypedValue mo3118b() {
        if (this.f1115f == null) {
    ...
    /* renamed from: e */
    public TypedValue mo3121e() {
        if (this.f1110a == null) {
            this.f1110a = new TypedValue();
        }
        return this.f1110a;
    }

    /* renamed from: f */
    public TypedValue mo3122f() {
        if (this.f1111b == null) {
    ...
    public void onMeasure(int r14, int r15) {
        ...
        L_0x0017:
            ...
            android.util.TypedValue r10 = r13.f1113d
            goto L_0x002e
        L_0x002c:
            android.util.TypedValue r10 = r13.f1112c
        L_0x002e:
        ...
        L_0x0048:
            if (r10 <= 0) goto L_0x0060
            android.graphics.Rect r11 = r13.f1116g
            int r12 = r11.left
            int r11 = r11.right
            int r12 = r12 + r11
            int r10 = r10 - r12
        ...
        L_0x0061:
            ...
            android.util.TypedValue r5 = r13.f1114e
            goto L_0x006a
        L_0x0068:
            android.util.TypedValue r5 = r13.f1115f
        L_0x006a:
        ...
        L_0x009a:
            ...
            android.util.TypedValue r1 = r13.f1111b
            goto L_0x00b0
        L_0x00ae:
            android.util.TypedValue r1 = r13.f1110a
        L_0x00b0:
        ...
        L_0x00ca:
            ...
            android.graphics.Rect r1 = r13.f1116g
            int r2 = r1.left
            int r1 = r1.right
            int r2 = r2 + r1
            int r0 = r0 - r2
    ...
    /* renamed from: a */
    public void mo3117a(C0536a aVar) {
        this.f1117h = aVar;
    }

    public ContentFrameLayout(Context context, AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        this.f1116g = new Rect();
    }

    /* renamed from: a */
    public void mo3115a(int i, int i2, int i3, int i4) {
        this.f1116g.set(i, i2, i3, i4);
        if (C0839t.m2736y(this)) {
            requestLayout();
        }
    }

    /* renamed from: a */
    public TypedValue mo3114a() {
        if (this.f1114e == null) {
