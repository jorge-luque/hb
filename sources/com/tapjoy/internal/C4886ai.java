...
public class C4886ai extends C4887aj {

    /* renamed from: a */
    private int f13350a = 0;

    /* renamed from: b */
    private final Matrix f13351b = new Matrix();

    /* renamed from: c */
    private final float[] f13352c = new float[2];

    public C4886ai(Context context) {
        super(context);
    }
    ...
    public void dispatchDraw(android.graphics.Canvas r9) {
        ...
        L_0x0076:
            ...
            r9.translate(r5, r2)
        L_0x007b:
            android.graphics.Matrix r2 = r8.f13351b
            int r7 = r8.f13350a
            int r7 = r7 * -90
            float r7 = (float) r7
            r2.setRotate(r7)
            ...
            android.graphics.Matrix r0 = r8.f13351b
            int r1 = r1 - r6
            float r1 = (float) r1
        ...
        L_0x009b:
            ...
            goto L_0x00ac
        L_0x00a5:
            android.graphics.Matrix r1 = r8.f13351b
            int r0 = r0 - r6
            float r0 = (float) r0
        ...
        L_0x00ac:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tapjoy.internal.C4886ai.dispatchDraw(android.graphics.Canvas):void");
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        float[] fArr = this.f13352c;
        fArr[0] = motionEvent.getX();
        fArr[1] = motionEvent.getY();
        this.f13351b.mapPoints(fArr);
