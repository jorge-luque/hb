...
public class TJCurrency {
    ...
    /* renamed from: d */
    private static TJGetCurrencyBalanceListener f13034d;

    /* renamed from: e */
    private static TJSpendCurrencyListener f13035e;

    /* renamed from: f */
    private static TJAwardCurrencyListener f13036f;

    /* renamed from: g */
    private static TJEarnedCurrencyListener f13037g;
    ...
    public void awardCurrency(int i, TJAwardCurrencyListener tJAwardCurrencyListener) {
        if (i < 0) {
            TapjoyLog.m16650e("TJCurrency", new TapjoyErrorMessage(TapjoyErrorMessage.ErrorType.INTEGRATION_ERROR, "Amount must be a positive number for the awardCurrency API"));
            return;
        }
        this.f13039b = i;
        f13036f = tJAwardCurrencyListener;
        String uuid = UUID.randomUUID().toString();
        long currentTimeMillis = System.currentTimeMillis() / 1000;
        final Map genericURLParams = TapjoyConnectCore.getGenericURLParams();
        TapjoyUtil.safePut(genericURLParams, TapjoyConstants.TJC_CURRENCY, String.valueOf(this.f13039b), true);
        ...
        TapjoyUtil.safePut(genericURLParams, TapjoyConstants.TJC_VERIFIER, TapjoyConnectCore.getAwardCurrencyVerifier(currentTimeMillis, this.f13039b, uuid), true);
        new Thread(new Runnable() {
            public final void run() {
                TapjoyURLConnection tapjoyURLConnection = new TapjoyURLConnection();
                TJCurrency.this.m16586c(tapjoyURLConnection.getResponseFromURL(TapjoyConnectCore.getHostURL() + TapjoyConstants.TJC_AWARD_CURRENCY_URL_PATH, genericURLParams));
            }
        }).start();
    }

    public void getCurrencyBalance(TJGetCurrencyBalanceListener tJGetCurrencyBalanceListener) {
        f13034d = tJGetCurrencyBalanceListener;
        final Map uRLParams = TapjoyConnectCore.getURLParams();
        new Thread(new Runnable() {
            public final void run() {
                TapjoyURLConnection tapjoyURLConnection = new TapjoyURLConnection();
                TJCurrency.this.m16582a(tapjoyURLConnection.getResponseFromURL(TapjoyConnectCore.getHostURL() + TapjoyConstants.TJC_GET_CURRENCY_BALANCE_URL_PATH, uRLParams));
            }
        }).start();
    }

    public int getLocalCurrencyBalance() {
        return this.f13040c.getSharedPreferences(TapjoyConstants.TJC_PREFERENCE, 0).getInt(TapjoyConstants.PREF_LAST_CURRENCY_BALANCE, -9999);
    }

    public void saveCurrencyBalance(int i) {
        SharedPreferences.Editor edit = this.f13040c.getSharedPreferences(TapjoyConstants.TJC_PREFERENCE, 0).edit();
    ...
    public void setEarnedCurrencyListener(TJEarnedCurrencyListener tJEarnedCurrencyListener) {
        f13037g = tJEarnedCurrencyListener;
    }

    public void spendCurrency(int i, TJSpendCurrencyListener tJSpendCurrencyListener) {
        if (i < 0) {
            TapjoyLog.m16650e("TJCurrency", new TapjoyErrorMessage(TapjoyErrorMessage.ErrorType.INTEGRATION_ERROR, "Amount must be a positive number for the spendCurrency API"));
            return;
        }
        this.f13038a = String.valueOf(i);
        f13035e = tJSpendCurrencyListener;
        final Map uRLParams = TapjoyConnectCore.getURLParams();
        TapjoyUtil.safePut(uRLParams, TapjoyConstants.TJC_CURRENCY, this.f13038a, true);
        new Thread(new Runnable() {
            public final void run() {
                TapjoyURLConnection tapjoyURLConnection = new TapjoyURLConnection();
                TJCurrency.this.m16584b(tapjoyURLConnection.getResponseFromURL(TapjoyConnectCore.getHostURL() + TapjoyConstants.TJC_SPEND_CURRENCY_URL_PATH, uRLParams));
            }
        }).start();
    }
    ...
    public synchronized void m16582a(com.tapjoy.TapjoyHttpURLResponse r6) {
        /*
            r5 = this;
            monitor-enter(r5)
            ...
            com.tapjoy.TJEarnedCurrencyListener r2 = f13037g     // Catch:{ Exception -> 0x0073 }
            ...
            com.tapjoy.TapjoyLog.m16652i(r2, r3)     // Catch:{ Exception -> 0x0073 }
            com.tapjoy.TJEarnedCurrencyListener r2 = f13037g     // Catch:{ Exception -> 0x0073 }
            r2.onEarnedCurrency(r6, r1)     // Catch:{ Exception -> 0x0073 }
        L_0x0065:
            r5.saveCurrencyBalance(r0)     // Catch:{ Exception -> 0x0073 }
            com.tapjoy.TJGetCurrencyBalanceListener r1 = f13034d     // Catch:{ Exception -> 0x0073 }
        ...
        L_0x0073:
            ...
            com.tapjoy.TapjoyLog.m16650e((java.lang.String) r0, (com.tapjoy.TapjoyErrorMessage) r1)     // Catch:{ all -> 0x00cc }
            goto L_0x00bf
        L_0x0093:
            ...
            com.tapjoy.TapjoyLog.m16650e((java.lang.String) r6, (com.tapjoy.TapjoyErrorMessage) r0)     // Catch:{ all -> 0x00cc }
            goto L_0x00bf
        L_0x00a2:
            java.lang.String r6 = "TJCurrency"
            com.tapjoy.TapjoyErrorMessage r0 = new com.tapjoy.TapjoyErrorMessage     // Catch:{ all -> 0x00cc }
        ...
        L_0x00b1:
            ...
            com.tapjoy.TapjoyLog.m16650e((java.lang.String) r6, (com.tapjoy.TapjoyErrorMessage) r0)     // Catch:{ all -> 0x00cc }
        L_0x00bf:
            com.tapjoy.TJGetCurrencyBalanceListener r6 = f13034d     // Catch:{ all -> 0x00cc }
        ...
        L_0x00cc:
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tapjoy.TJCurrency.m16582a(com.tapjoy.TapjoyHttpURLResponse):void");
    }
    ...
    /* renamed from: b */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public synchronized void m16584b(com.tapjoy.TapjoyHttpURLResponse r5) {
        /*
            r4 = this;
            monitor-enter(r4)
            ...
            com.tapjoy.TJSpendCurrencyListener r1 = f13035e     // Catch:{ all -> 0x00b3 }
        ...
        L_0x004d:
            ...
            com.tapjoy.TapjoyLog.m16650e((java.lang.String) r5, (com.tapjoy.TapjoyErrorMessage) r1)     // Catch:{ all -> 0x00b3 }
            goto L_0x00a8
        L_0x005c:
            ...
            com.tapjoy.TapjoyLog.m16652i(r1, r0)     // Catch:{ all -> 0x00b3 }
            ...
            if (r5 == 0) goto L_0x00a8
            com.tapjoy.internal.C5094fr.m17213a()     // Catch:{ all -> 0x00b3 }
            goto L_0x00a8
        L_0x008b:
            java.lang.String r5 = "TJCurrency"
            com.tapjoy.TapjoyErrorMessage r1 = new com.tapjoy.TapjoyErrorMessage     // Catch:{ all -> 0x00b3 }
        ...
        L_0x009a:
            ...
            com.tapjoy.TapjoyLog.m16650e((java.lang.String) r5, (com.tapjoy.TapjoyErrorMessage) r1)     // Catch:{ all -> 0x00b3 }
        L_0x00a8:
            com.tapjoy.TJSpendCurrencyListener r5 = f13035e     // Catch:{ all -> 0x00b3 }
        ...
        L_0x00b3:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tapjoy.TJCurrency.m16584b(com.tapjoy.TapjoyHttpURLResponse):void");
    }
    ...
    /* renamed from: c */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public synchronized void m16586c(com.tapjoy.TapjoyHttpURLResponse r5) {
        /*
            r4 = this;
            monitor-enter(r4)
            ...
            com.tapjoy.TJAwardCurrencyListener r1 = f13036f     // Catch:{ all -> 0x009e }
            if (r1 == 0) goto L_0x004b
            com.tapjoy.TJAwardCurrencyListener r1 = f13036f     // Catch:{ all -> 0x009e }
        ...
        L_0x004d:
            ...
            com.tapjoy.TapjoyLog.m16650e((java.lang.String) r5, (com.tapjoy.TapjoyErrorMessage) r1)     // Catch:{ all -> 0x009e }
            goto L_0x0093
        L_0x005c:
            ...
            java.lang.String r5 = "TJCurrency"
            com.tapjoy.TapjoyLog.m16652i(r5, r0)     // Catch:{ all -> 0x009e }
            goto L_0x0093
        L_0x0076:
            java.lang.String r5 = "TJCurrency"
            com.tapjoy.TapjoyErrorMessage r1 = new com.tapjoy.TapjoyErrorMessage     // Catch:{ all -> 0x009e }
        ...
        L_0x0085:
            ...
            com.tapjoy.TapjoyLog.m16650e((java.lang.String) r5, (com.tapjoy.TapjoyErrorMessage) r1)     // Catch:{ all -> 0x009e }
        L_0x0093:
            com.tapjoy.TJAwardCurrencyListener r5 = f13036f     // Catch:{ all -> 0x009e }
        ...
        L_0x009e:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tapjoy.TJCurrency.m16586c(com.tapjoy.TapjoyHttpURLResponse):void");
    }
}
