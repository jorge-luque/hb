        ...
        return new FutureTask<>(new Callable<LocationPackage>() {
            ...
            public com.facebook.places.internal.LocationPackage call() throws java.lang.Exception {
                ...
                L_0x005f:
                    return r0
                */
                throw new UnsupportedOperationException("Method not decompiled: com.facebook.places.internal.LocationPackageManager.C28173.call():com.facebook.places.internal.LocationPackage");
            }
        });
    }
