    ...
    public static DynamicLoader doMakeLoader(Context context, boolean z) throws Exception {
        ...
        if (dynamicLoader == null) {
            if (!LOAD_FROM_ASSETS) {
                ...
                "SDK dex loading time: " + (System.currentTimeMillis() - System.currentTimeMillis());
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    L_0x0053:
                        goto L_0x0052
                    */
                    throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.internal.dynamicloading.DynamicLoaderFactory.C26391.run():void");
                }
            }).start();
        }
    }
