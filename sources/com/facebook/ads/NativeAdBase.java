...
@Keep
public abstract class NativeAdBase implements C2630Ad {
    ...
    @Keep
    public interface NativeAdLoadConfigBuilder extends C2630Ad.LoadConfigBuilder {
    ...
    @Keep
    public interface NativeLoadAdConfig extends C2630Ad.LoadAdConfig {
    }
