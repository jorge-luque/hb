...
import com.facebook.login.C2790R;
...
public class LoginButton extends FacebookButtonBase {
    ...
    static /* synthetic */ class C27993 {
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.login.widget.LoginButton.C27993.<clinit>():void");
        }
    }
    ...
    protected class LoginClickListener implements View.OnClickListener {
        ...
        public void performLogout(Context context) {
            ...
            if (LoginButton.this.confirmLogout) {
                String string = LoginButton.this.getResources().getString(C2790R.string.com_facebook_loginview_log_out_action);
                String string2 = LoginButton.this.getResources().getString(C2790R.string.com_facebook_loginview_cancel_action);
                Profile currentProfile = Profile.getCurrentProfile();
                if (currentProfile == null || currentProfile.getName() == null) {
                    str = LoginButton.this.getResources().getString(C2790R.string.com_facebook_loginview_logged_in_using_facebook);
                } else {
                    str = String.format(LoginButton.this.getResources().getString(C2790R.string.com_facebook_loginview_logged_in_as), new Object[]{currentProfile.getName()});
                }
    ...
    private void checkToolTipSettings() {
        int i = C27993.$SwitchMap$com$facebook$login$widget$LoginButton$ToolTipMode[this.toolTipMode.ordinal()];
        if (i == 1) {
            ...
            displayToolTip(getResources().getString(C2790R.string.com_facebook_tooltip_default));
        }
    }
    ...
    private void parseLoginButtonAttributes(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet, C2790R.styleable.com_facebook_login_view, i, i2);
        try {
            this.confirmLogout = obtainStyledAttributes.getBoolean(C2790R.styleable.com_facebook_login_view_com_facebook_confirm_logout, true);
            this.loginText = obtainStyledAttributes.getString(C2790R.styleable.com_facebook_login_view_com_facebook_login_text);
            this.logoutText = obtainStyledAttributes.getString(C2790R.styleable.com_facebook_login_view_com_facebook_logout_text);
            this.toolTipMode = ToolTipMode.fromInt(obtainStyledAttributes.getInt(C2790R.styleable.com_facebook_login_view_com_facebook_tooltip_mode, ToolTipMode.DEFAULT.getValue()));
        } finally {
    ...
    public void setButtonText() {
        ...
        if (isInEditMode() || !AccessToken.isCurrentAccessTokenActive()) {
            ...
            String string = resources.getString(C2790R.string.com_facebook_loginview_log_in_button_continue);
            int width = getWidth();
            if (width != 0 && measureButtonWidth(string) > width) {
                string = resources.getString(C2790R.string.com_facebook_loginview_log_in_button);
            }
            setText(string);
            return;
        }
        ...
        if (str2 == null) {
            str2 = resources.getString(C2790R.string.com_facebook_loginview_log_out_button);
        }
        setText(str2);
    }
    ...
    public void configureButton(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        if (isInEditMode()) {
            setBackgroundColor(getResources().getColor(C2707R.color.com_facebook_blue));
    ...
    public int getDefaultStyleResource() {
        return C2790R.style.com_facebook_loginview_default_style;
    }
    ...
    public void onMeasure(int i, int i2) {
        ...
        String str = this.loginText;
        if (str == null) {
            str = resources.getString(C2790R.string.com_facebook_loginview_log_in_button_continue);
            int measureButtonWidth = measureButtonWidth(str);
            if (Button.resolveSize(measureButtonWidth, i) < measureButtonWidth) {
                str = resources.getString(C2790R.string.com_facebook_loginview_log_in_button);
            }
        }
