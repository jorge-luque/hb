...
public class DeviceAuthDialog extends C0909b {
    ...
    public void presentConfirmation(String str, Utility.PermissionsLists permissionsLists, String str2, String str3, Date date, Date date2) {
        String string = getResources().getString(C2707R.string.com_facebook_smart_login_confirmation_title);
        String string2 = getResources().getString(C2707R.string.com_facebook_smart_login_confirmation_continue_as);
        String string3 = getResources().getString(C2707R.string.com_facebook_smart_login_confirmation_cancel);
    ...
    public int getLayoutResId(boolean z) {
        return z ? C2707R.layout.com_facebook_smart_device_dialog_fragment : C2707R.layout.com_facebook_device_auth_dialog_fragment;
    }
    ...
    public View initializeContentView(boolean z) {
        ...
        this.progressBar = inflate.findViewById(C2707R.C2709id.progress_bar);
        ...
        TextView textView = (TextView) inflate.findViewById(C2707R.C2709id.com_facebook_device_auth_instructions);
        this.instructions = textView;
        textView.setText(Html.fromHtml(getString(C2707R.string.com_facebook_device_auth_instructions)));
        return inflate;
    }
