...
public final class InstrumentData {
    ...
    static /* synthetic */ class C27571 {
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.internal.instrument.InstrumentData.C27571.<clinit>():void");
        }
    }
    ...
    public enum Type {
        ...
        public String toString() {
            int i = C27571.$SwitchMap$com$facebook$internal$instrument$InstrumentData$Type[ordinal()];
            if (i == 1) {
                return "CrashReport";
            }
            if (i != 2) {
