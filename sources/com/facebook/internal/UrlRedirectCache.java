        ...
        try {
            ...
            while (true) {
                try {
                    ...
                    try {
                        char[] cArr = new char[OguryChoiceManager.TcfV2.Purpose.MEASURE_AD_PERFORMANCE];
                        StringBuilder sb = new StringBuilder();
                        while (true) {
                            int read = inputStreamReader2.read(cArr, 0, OguryChoiceManager.TcfV2.Purpose.MEASURE_AD_PERFORMANCE);
                            if (read <= 0) {
                                break;
                            }
