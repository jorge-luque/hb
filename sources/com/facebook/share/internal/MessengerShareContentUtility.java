...
public class MessengerShareContentUtility {
    ...
    static /* synthetic */ class C28691 {
        ...
        static {
            ...
            L_0x0034:
                int[] r0 = f8192x92e77847     // Catch:{ NoSuchFieldError -> 0x003f }
            ...
            L_0x003f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.share.internal.MessengerShareContentUtility.C28691.<clinit>():void");
        }
    }
    ...
    private static String getImageRatioString(ShareMessengerGenericTemplateContent.ImageAspectRatio imageAspectRatio) {
        return (imageAspectRatio != null && C28691.f8190xb7309c05[imageAspectRatio.ordinal()] == 1) ? IMAGE_RATIO_SQUARE : IMAGE_RATIO_HORIZONTAL;
    }

    private static String getMediaType(ShareMessengerMediaTemplateContent.MediaType mediaType) {
        return (mediaType != null && C28691.f8191x2a75e664[mediaType.ordinal()] == 1) ? "video" : MEDIA_IMAGE;
    }
    ...
    private static String getWebviewHeightRatioString(ShareMessengerURLActionButton.WebviewHeightRatio webviewHeightRatio) {
        ...
        int i = C28691.f8192x92e77847[webviewHeightRatio.ordinal()];
        if (i != 1) {
