...
public final class ShareDialog extends FacebookDialogBase<ShareContent, Sharer.Result> implements Sharer {
    ...
    static /* synthetic */ class C29271 {
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.share.widget.ShareDialog.C29271.<clinit>():void");
        }
    }
    ...
    private class CameraEffectHandler extends FacebookDialogBase<ShareContent, Sharer.Result>.ModeHandler {
        ...
        /* synthetic */ CameraEffectHandler(ShareDialog shareDialog, C29271 r2) {
            this();
        }
    ...
    private class FeedHandler extends FacebookDialogBase<ShareContent, Sharer.Result>.ModeHandler {
        ...
        /* synthetic */ FeedHandler(ShareDialog shareDialog, C29271 r2) {
            this();
        }
    ...
    private class NativeHandler extends FacebookDialogBase<ShareContent, Sharer.Result>.ModeHandler {
        ...
        /* synthetic */ NativeHandler(ShareDialog shareDialog, C29271 r2) {
            this();
        }
    ...
    private class ShareStoryHandler extends FacebookDialogBase<ShareContent, Sharer.Result>.ModeHandler {
        ...
        /* synthetic */ ShareStoryHandler(ShareDialog shareDialog, C29271 r2) {
            this();
        }
    ...
    private class WebShareHandler extends FacebookDialogBase<ShareContent, Sharer.Result>.ModeHandler {
        ...
        /* synthetic */ WebShareHandler(ShareDialog shareDialog, C29271 r2) {
            this();
        }
    ...
    public void logDialogShare(Context context, ShareContent shareContent, Mode mode) {
        ...
        int i = C29271.$SwitchMap$com$facebook$share$widget$ShareDialog$Mode[mode.ordinal()];
        String str = "unknown";
    ...
    public List<FacebookDialogBase<ShareContent, Sharer.Result>.ModeHandler> getOrderedModeHandlers() {
        ArrayList arrayList = new ArrayList();
        arrayList.add(new NativeHandler(this, (C29271) null));
        arrayList.add(new FeedHandler(this, (C29271) null));
        arrayList.add(new WebShareHandler(this, (C29271) null));
        arrayList.add(new CameraEffectHandler(this, (C29271) null));
        arrayList.add(new ShareStoryHandler(this, (C29271) null));
        return arrayList;
    }
