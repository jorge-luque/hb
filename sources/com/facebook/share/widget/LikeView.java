...
public class LikeView extends FrameLayout {
    ...
    static /* synthetic */ class C29232 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f8195x30689ac     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f8195x30689ac     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.share.widget.LikeView.C29232.<clinit>():void");
        }
    }
    ...
    public void associateWithLikeActionController(LikeActionController likeActionController2) {
        ...
        C3218a a = C3218a.m10641a(getContext());
        ...
        a.mo18871a(this.broadcastReceiver, intentFilter);
    }
    ...
    private void initialize(Context context) {
        this.edgePadding = getResources().getDimensionPixelSize(C2707R.dimen.com_facebook_likeview_edge_padding);
        this.internalPadding = getResources().getDimensionPixelSize(C2707R.dimen.com_facebook_likeview_internal_padding);
        if (this.foregroundColor == -1) {
            this.foregroundColor = getResources().getColor(C2707R.color.com_facebook_likeview_text_color);
        }
    ...
    private void initializeSocialSentenceView(Context context) {
        ...
        textView.setTextSize(0, getResources().getDimension(C2707R.dimen.com_facebook_likeview_text_size));
    ...
    private void parseAttributes(AttributeSet attributeSet) {
        ...
        if (attributeSet != null && getContext() != null && (obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, C2707R.styleable.com_facebook_like_view)) != null) {
            this.objectId = Utility.coerceValueIfNullOrEmpty(obtainStyledAttributes.getString(C2707R.styleable.com_facebook_like_view_com_facebook_object_id), (String) null);
            this.objectType = ObjectType.fromInt(obtainStyledAttributes.getInt(C2707R.styleable.com_facebook_like_view_com_facebook_object_type, ObjectType.DEFAULT.getValue()));
            Style fromInt = Style.fromInt(obtainStyledAttributes.getInt(C2707R.styleable.com_facebook_like_view_com_facebook_style, Style.DEFAULT.getValue()));
            this.likeViewStyle = fromInt;
            if (fromInt != null) {
                AuxiliaryViewPosition fromInt2 = AuxiliaryViewPosition.fromInt(obtainStyledAttributes.getInt(C2707R.styleable.com_facebook_like_view_com_facebook_auxiliary_view_position, AuxiliaryViewPosition.DEFAULT.getValue()));
                this.auxiliaryViewPosition = fromInt2;
                if (fromInt2 != null) {
                    HorizontalAlignment fromInt3 = HorizontalAlignment.fromInt(obtainStyledAttributes.getInt(C2707R.styleable.com_facebook_like_view_com_facebook_horizontal_alignment, HorizontalAlignment.DEFAULT.getValue()));
                    this.horizontalAlignment = fromInt3;
                    if (fromInt3 != null) {
                        this.foregroundColor = obtainStyledAttributes.getColor(C2707R.styleable.com_facebook_like_view_com_facebook_foreground_color, -1);
    ...
    private void updateBoxCountCaretPosition() {
        int i = C29232.f8195x30689ac[this.auxiliaryViewPosition.ordinal()];
        if (i == 1) {
    ...
    private void updateLayout() {
        ...
        if (auxiliaryViewPosition2 == AuxiliaryViewPosition.TOP || (auxiliaryViewPosition2 == AuxiliaryViewPosition.INLINE && this.horizontalAlignment == HorizontalAlignment.RIGHT)) {
        ...
        int i3 = C29232.f8195x30689ac[this.auxiliaryViewPosition.ordinal()];
        if (i3 == 1) {
