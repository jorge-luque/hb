...
final class UserSettingsManager {
    ...
    private static void loadSettingFromManifest(UserSetting userSetting) {
        ...
        try {
            ...
            ApplicationInfo applicationInfo = applicationContext.getPackageManager().getApplicationInfo(applicationContext.getPackageName(), OguryChoiceManager.TcfV2.Purpose.MEASURE_AD_PERFORMANCE);
