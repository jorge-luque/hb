...
import com.facebook.appevents.p069ml.C2690Model;
import com.facebook.appevents.p069ml.ModelManager;
...
public final class AddressFilterManager {
    ...
    private static boolean shouldFilterKey(String str) {
        ...
        return predict != null && predict.equals(C2690Model.SHOULD_FILTER);
    }
}
