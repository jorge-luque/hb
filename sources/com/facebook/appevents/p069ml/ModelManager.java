...
public final class ModelManager {
    ...
    public static final ConcurrentMap<String, C2690Model> models = new ConcurrentHashMap();
    /* access modifiers changed from: private */
    ...
    public static void addModelsFromModelJson(JSONObject jSONObject) {
        ...
        while (keys.hasNext()) {
            try {
                ...
                C2690Model jsonObjectToModel = jsonObjectToModel(jSONObject.getJSONObject(next));
        ...
        if (models.containsKey(MODEL_ADDRESS_DETECTION)) {
            FeatureManager.checkFeature(FeatureManager.Feature.PIIFiltering, new FeatureManager.Callback() {
                public void onCompleted(boolean z) {
                    if (z) {
                        ((C2690Model) ModelManager.models.get(ModelManager.MODEL_ADDRESS_DETECTION)).initialize(new Runnable() {
                            public void run() {
        ...
        if (models.containsKey(MODEL_SUGGESTED_EVENTS)) {
            ...
            if (resourceLocale == null || resourceLocale.getLanguage().contains("en")) {
                FeatureManager.checkFeature(FeatureManager.Feature.SuggestedEvents, new FeatureManager.Callback() {
                    public void onCompleted(boolean z) {
                        if (z) {
                            ((C2690Model) ModelManager.models.get(ModelManager.MODEL_SUGGESTED_EVENTS)).initialize(new Runnable() {
                                public void run() {
    ...
    public static File getRuleFile(String str) {
        ...
        return ((C2690Model) models.get(str)).getRuleFile();
    }
    ...
    private static C2690Model jsonObjectToModel(JSONObject jSONObject) {
        try {
            return new C2690Model(jSONObject.getString("use_case"), Integer.parseInt(jSONObject.getString("version_id")), jSONObject.getString("asset_uri"), jSONObject.optString("rules_uri", (String) null), parseJsonArray(jSONObject.getJSONArray("thresholds")));
        } catch (JSONException unused) {
            return null;
        }
    }
    ...
    public static String predict(String str, float[] fArr, String str2) {
        ...
        return ((C2690Model) models.get(str)).predict(fArr, str2);
    }
}
