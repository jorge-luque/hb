...
public class CustomTabMainActivity extends Activity {
    ...
    private void sendResult(int i, Intent intent) {
        C3218a.m10641a((Context) this).mo18870a(this.redirectReceiver);
        if (intent != null) {
            setResult(i, intent);
        } else {
            setResult(i);
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (CustomTabActivity.CUSTOM_TAB_REDIRECT_ACTION.equals(getIntent().getAction())) {
            ...
            C3218a.m10641a((Context) this).mo18871a(this.redirectReceiver, new IntentFilter(CustomTabActivity.CUSTOM_TAB_REDIRECT_ACTION));
        }
    }
    ...
    public void onNewIntent(Intent intent) {
        ...
        if (REFRESH_ACTION.equals(intent.getAction())) {
            C3218a.m10641a((Context) this).mo18872a(new Intent(CustomTabActivity.DESTROY_ACTION));
            sendResult(-1, intent);
