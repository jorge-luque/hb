...
public final class Profile implements Parcelable {
    ...
    public boolean equals(Object obj) {
        ...
        if (!this.f8180id.equals(profile.f8180id) || this.firstName != null) {
    ...
    public Uri getProfilePictureUri(int i, int i2) {
        return ImageRequest.getProfilePictureUri(this.f8180id, i, i2, AccessToken.isCurrentAccessTokenActive() ? AccessToken.getCurrentAccessToken().getToken() : "");
    }

    public int hashCode() {
        int hashCode = 527 + this.f8180id.hashCode();
    ...
    public JSONObject toJSONObject() {
        ...
        try {
            jSONObject.put("id", this.f8180id);
    ...
    public void writeToParcel(Parcel parcel, int i) {
        parcel.writeString(this.f8180id);
    ...
    Profile(JSONObject jSONObject) {
        Uri uri = null;
        this.f8180id = jSONObject.optString("id", (String) null);
    ...
    private Profile(Parcel parcel) {
        Uri uri;
        this.f8180id = parcel.readString();
