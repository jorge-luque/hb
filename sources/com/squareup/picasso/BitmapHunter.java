...
class BitmapHunter implements Runnable {
    ...
    static Bitmap decodeStream(C3586u uVar, Request request) throws IOException {
        ...
        InputStream V = a.mo19688V();
        if (requiresInSampleSize) {
            MarkableInputStream markableInputStream = new MarkableInputStream(V);
            markableInputStream.allowMarksToExpire(false);
            long savePosition = markableInputStream.savePosition(OguryChoiceManager.TcfV2.Purpose.DEVELOP_AND_IMPROVE_PRODUCTS);
            ...
            V = markableInputStream;
        }
        Bitmap decodeStream = BitmapFactory.decodeStream(V, (Rect) null, createBitmapOptions);
