...
class C4728y {
    ...
    /* renamed from: a */
    private static final Pattern f12836a = Pattern.compile("^([A-Fa-f0-9]{8})$");

    /* renamed from: a */
    private static int m16431a(int i) {
        if (i > 9) {
            return 5;
        }
        if (i > 7) {
    ...
    /* renamed from: a */
    static String m16434a(C4467a0 a0Var) {
        if (Build.VERSION.SDK_INT < 26) {
            return "fcm_fallback_notification_channel";
        }
        Context context = a0Var.f12267a;
        ...
        if (jSONObject.has("oth_chnl")) {
            ...
            if (d.getNotificationChannel(optString) != null) {
                return optString;
            }
        }
        ...
        try {
            return m16433a(context, d, jSONObject);
        } catch (JSONException e) {
            C4564n1.m15790a(C4564n1.C4566a0.ERROR, "Could not create notification channel due to JSON payload error!", (Throwable) e);
            return "fcm_fallback_notification_channel";
        }
    }

    /* renamed from: b */
    private static String m16436b(NotificationManager notificationManager) {
    ...
    private static java.lang.String m16433a(android.content.Context r7, android.app.NotificationManager r8, org.json.JSONObject r9) throws org.json.JSONException {
        /*
        ...
        L_0x0027:
            ...
            java.lang.String r3 = com.onesignal.C4536k1.m15636e()
        ...
        L_0x0082:
            ...
            java.util.regex.Pattern r2 = f12836a
            java.util.regex.Matcher r2 = r2.matcher(r1)
            boolean r2 = r2.matches()
            if (r2 != 0) goto L_0x00a3
            com.onesignal.n1$a0 r1 = com.onesignal.C4564n1.C4566a0.WARN
            java.lang.String r2 = "OneSignal LED Color Settings: ARGB Hex value incorrect format (E.g: FF9900FF)"
            com.onesignal.C4564n1.m15789a((com.onesignal.C4564n1.C4566a0) r1, (java.lang.String) r2)
        ...
        L_0x00b2:
            ...
            com.onesignal.C4564n1.m15790a((com.onesignal.C4564n1.C4566a0) r2, (java.lang.String) r4, (java.lang.Throwable) r1)
        L_0x00ba:
            r1 = 1
        ...
        L_0x00c7:
            ...
            long[] r2 = com.onesignal.C4536k1.m15628a((org.json.JSONObject) r9)
            if (r2 == 0) goto L_0x00db
        ...
        L_0x00e6:
            ...
            android.net.Uri r7 = com.onesignal.C4536k1.m15634c(r7, r2)
        ...
        L_0x0133:
            r5.setBypassDnd(r1)
            com.onesignal.n1$a0 r7 = com.onesignal.C4564n1.C4566a0.VERBOSE
            ...
            com.onesignal.C4564n1.m15815b((com.onesignal.C4564n1.C4566a0) r7, (java.lang.String) r9)
        ...
        L_0x0158:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.onesignal.C4728y.m16433a(android.content.Context, android.app.NotificationManager, org.json.JSONObject):java.lang.String");
    }

    /* renamed from: a */
    private static String m16432a(NotificationManager notificationManager) {
    ...
    /* renamed from: a */
    static void m16435a(Context context, JSONArray jSONArray) {
        if (Build.VERSION.SDK_INT >= 26 && jSONArray != null) {
            ...
            for (int i = 0; i < length; i++) {
                try {
                    hashSet.add(m16433a(context, d, jSONArray.getJSONObject(i)));
                } catch (JSONException e) {
                    C4564n1.m15790a(C4564n1.C4566a0.ERROR, "Could not create notification channel due to JSON payload error!", (Throwable) e);
                }
            }
            for (NotificationChannel id : d.getNotificationChannels()) {
                String id2 = id.getId();
                if (id2.startsWith("OS_") && !hashSet.contains(id2)) {
                    d.deleteNotificationChannel(id2);
                }
            }
        }
    }
