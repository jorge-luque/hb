...
public abstract class CommunicatorMessageImpl extends Intent {
    ...
    /* renamed from: a */
    private final String f5084a = UUID.randomUUID().toString();
    ...
    public String toString() {
        return "AppLovinCommunicatorMessage{publisherId=" + getPublisherId() + ", topic=" + getTopic() + '\'' + ", uniqueId='" + this.f5084a + '\'' + ", data=" + this.data + ", sticky=" + this.sticky + '}';
    }
}
