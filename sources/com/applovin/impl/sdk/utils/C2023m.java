...
public class C2023m {
    ...
    public static String m7940a(String str, String str2) {
        return m7943a(str, str2, new byte[]{-83, -98, -53, -112, -29, -118, 55, 117, 59, 8, -12, -15, 73, 110, -67, 57, 117, 4, -26, 97, 66, -12, 125, 91, -119, -103, -30, 114, 123, 54, 51, -77});
    }

    /* renamed from: a */
    public static String m7941a(String str, String str2, long j) {
        return m7942a(str, str2, j, new byte[]{-83, -98, -53, -112, -29, -118, 55, 117, 59, 8, -12, -15, 73, 110, -67, 57, 117, 4, -26, 97, 66, -12, 125, 91, -119, -103, -30, 114, 123, 54, 51, -77});
    }

    /* renamed from: a */
    private static String m7942a(String str, String str2, long j, byte[] bArr) {
        String str3 = str;
        String str4 = str2;
        byte[] bArr2 = bArr;
        if (str4 == null) {
            ...
            if (bArr2.length < 32) {
                ...
                try {
                    ...
                    byte[] bytes = str3.getBytes(C4250c.DEFAULT_CHARSET);
                    byte[] a = m7946a(substring2, bArr2);
                    ...
                    String b = m7948b(byteArrayOutputStream.toByteArray());
                    String a2 = m7944a(bArr);
    ...
    /* renamed from: a */
    private static String m7943a(String str, String str2, byte[] bArr) {
        String str3 = str;
        String str4 = str2;
        byte[] bArr2 = bArr;
        if (str4 == null) {
            ...
            if (bArr2.length < 32) {
                ...
                try {
                    ...
                    String str5 = split[1];
                    String str6 = split[2];
                    byte[] a = m7945a(split[3]);
                    if (!str4.endsWith(str6)) {
                        return null;
                    }
                    if (!m7944a(bArr).equals(str5)) {
                        return null;
                    }
                    byte[] a2 = m7946a(str4.substring(0, 32), bArr2);
                    ...
                    try {
                        ...
                        return new String(byteArrayOutputStream.toByteArray(), C4250c.DEFAULT_CHARSET).trim();
                    } catch (IOException unused) {
                        return null;
                    }
    ...
    private static String m7944a(byte[] bArr) {
        try {
            ...
            return C2025o.m7960a(instance.digest());
    ...
    /* renamed from: a */
    private static byte[] m7945a(String str) {
        return Base64.decode(m7947b(str), 0);
    }

    /* renamed from: a */
    private static byte[] m7946a(String str, byte[] bArr) {
        try {
    ...
    /* renamed from: b */
    private static String m7947b(String str) {
        return str.replace('-', '+').replace('_', '/').replace('*', '=');
    }

    /* renamed from: b */
    private static String m7948b(byte[] bArr) throws UnsupportedEncodingException {
        return m7949c(Base64.encode(bArr, 2));
    }

    /* renamed from: c */
    private static String m7949c(byte[] bArr) throws UnsupportedEncodingException {
        return new String(bArr, C4250c.DEFAULT_CHARSET).replace('+', '-').replace('/', '_').replace('=', '*');
    }
}
