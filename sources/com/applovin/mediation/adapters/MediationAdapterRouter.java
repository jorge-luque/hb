...
public abstract class MediationAdapterRouter {
    ...
    protected C1941j mSdk;
    protected final String mTag = MediationAdapterRouter.class.getSimpleName();
    ...
    protected MediationAdapterRouter() {
        for (AppLovinSdk next : AppLovinSdk.m8096a()) {
            if (AppLovinMediationProvider.MAX.equalsIgnoreCase(next.getMediationProvider())) {
                this.mSdk = C2029r.m7993a(next);
            }
        }
        if (this.mSdk == null) {
            C1977q.m7751i(this.mTag, "Invalid mediation provider detected. Please set AppLovin SDK mediation provider to MAX via AppLovinSdk.getInstance(context).setMediationProvider( AppLovinMediationProvider.MAX )");
        }
    }
    ...
    public void log(String str) {
        C1941j jVar = this.mSdk;
        if (jVar != null) {
            jVar.mo8602v().mo8744c(this.mTag, str);
        }
    }
    ...
    public void log(String str, Throwable th) {
        C1941j jVar = this.mSdk;
        if (jVar != null) {
            jVar.mo8602v().mo8743b(this.mTag, str, th);
        }
    }
