...
public class WakeLockTracker {
    private static WakeLockTracker zzgs = new WakeLockTracker();
    private static Boolean zzgt;
    @VisibleForTesting
    private static boolean zzgu = false;
    ...
    private static void zza(Context context, WakeLockEvent wakeLockEvent) {
        try {
            context.startService(new Intent().setComponent(LoggingConstants.zzfv).putExtra("com.google.android.gms.common.stats.EXTRA_LOG_EVENT", wakeLockEvent));
        } catch (Exception e) {
