...
public class GoogleApiAvailability extends GoogleApiAvailabilityLight {
    ...
    static void zaa(Activity activity, Dialog dialog, String str, DialogInterface.OnCancelListener onCancelListener) {
        if (activity instanceof C0911c) {
            SupportErrorDialogFragment.newInstance(dialog, onCancelListener).show(((C0911c) activity).getSupportFragmentManager(), str);
            return;
        }
    ...
    private final void zaa(Context context, int i, String str, PendingIntent pendingIntent) {
        ...
        if (i == 18) {
            ...
            C0725i.C0730e eVar = new C0725i.C0730e(context);
            eVar.mo3941c(true);
            eVar.mo3931a(true);
            eVar.mo3936b((CharSequence) errorNotificationTitle);
            C0725i.C0728c cVar = new C0725i.C0728c();
            cVar.mo3916a((CharSequence) errorNotificationMessage);
            eVar.mo3928a((C0725i.C0733h) cVar);
            if (DeviceProperties.isWearable(context)) {
                Preconditions.checkState(PlatformVersion.isAtLeastKitKatWatch());
                eVar.mo3946f(context.getApplicationInfo().icon);
                eVar.mo3944e(2);
                if (DeviceProperties.isWearableWithoutPlayStore(context)) {
                    eVar.mo3921a(C3082R.C3083drawable.common_full_open_on_phone, (CharSequence) resources.getString(C3082R.string.common_open_on_phone), pendingIntent);
                } else {
                    eVar.mo3923a(pendingIntent);
                }
            } else {
                eVar.mo3946f(17301642);
                eVar.mo3940c((CharSequence) resources.getString(C3082R.string.common_google_play_services_notification_ticker));
                eVar.mo3922a(System.currentTimeMillis());
                eVar.mo3923a(pendingIntent);
                eVar.mo3929a((CharSequence) errorNotificationMessage);
            }
            if (PlatformVersion.isAtLeastO()) {
