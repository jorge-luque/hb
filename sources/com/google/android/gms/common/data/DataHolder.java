...
public final class DataHolder extends AbstractSafeParcelable implements Closeable {
    ...
    @SafeParcelable.Field(getter = "getColumns", mo15196id = 1)
    private final String[] zalq;
    private Bundle zalr;
    @SafeParcelable.Field(getter = "getWindows", mo15196id = 2)
    private final CursorWindow[] zals;
    @SafeParcelable.Field(getter = "getStatusCode", mo15196id = 3)
    private final int zalt;
    @SafeParcelable.Field(getter = "getMetadata", mo15196id = 4)
    ...
    DataHolder(@SafeParcelable.Param(mo15199id = 1000) int i, @SafeParcelable.Param(mo15199id = 1) String[] strArr, @SafeParcelable.Param(mo15199id = 2) CursorWindow[] cursorWindowArr, @SafeParcelable.Param(mo15199id = 3) int i2, @SafeParcelable.Param(mo15199id = 4) Bundle bundle) {
        this.mClosed = false;
        this.zalx = true;
        this.zalf = i;
        this.zalq = strArr;
