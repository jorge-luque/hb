...
public final class ConnectionResult extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getErrorCode", mo15196id = 2)
    private final int zzr;
    @SafeParcelable.Field(getter = "getResolution", mo15196id = 3)
    private final PendingIntent zzs;
    @SafeParcelable.Field(getter = "getErrorMessage", mo15196id = 4)
    private final String zzt;

    @SafeParcelable.Constructor
    ConnectionResult(@SafeParcelable.Param(mo15199id = 1) int i, @SafeParcelable.Param(mo15199id = 2) int i2, @SafeParcelable.Param(mo15199id = 3) PendingIntent pendingIntent, @SafeParcelable.Param(mo15199id = 4) String str) {
        this.zzq = i;
        this.zzr = i2;
            ...
            default:
                switch (i) {
                    case 13:
                        return "CANCELED";
                    case 14:
                        return AdMostBannerResponseFailReason.TIMEOUT;
                    case 15:
                        return "INTERRUPTED";
                    case 16:
