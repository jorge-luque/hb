...
final class zzc {
    ...
    private static volatile zzm zzy;
    ...
    private static zzl zzb(String str, zzd zzd, boolean z, boolean z2) {
        try {
            if (zzy == null) {
                ...
                synchronized (zzz) {
                    if (zzy == null) {
                        zzy = zzo.zzc(DynamiteModule.load(zzaa, DynamiteModule.PREFER_HIGHEST_OR_LOCAL_VERSION_NO_FORCE_STAGING, "com.google.android.gms.googlecertificates").instantiate("com.google.android.gms.common.GoogleCertificatesImpl"));
                    }
                }
            }
            Preconditions.checkNotNull(zzaa);
