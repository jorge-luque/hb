...
public class GooglePlayServicesUtilLight {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:2:0x0006, code lost:
        r1 = ((android.os.UserManager) r1.getSystemService(com.qumpara.offerwall.sdk.core.QumparaOfferwallUtil.TABLE_NAME)).getApplicationRestrictions(r1.getPackageName());
     */
    ...
    public static int isGooglePlayServicesAvailable(Context context, int i) {
        try {
            context.getResources().getString(C3085R.string.common_google_play_services_unknown_issue);
        ...
        if (!"com.google.android.gms".equals(context.getPackageName()) && !zzaz.get()) {
            ...
            } else if (zze != GOOGLE_PLAY_SERVICES_VERSION_CODE) {
