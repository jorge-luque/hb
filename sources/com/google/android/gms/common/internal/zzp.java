    ...
    private static void zzf(Context context) {
        synchronized (sLock) {
            if (!zzfc) {
                zzfc = true;
                try {
                    Bundle bundle = Wrappers.packageManager(context).getApplicationInfo(context.getPackageName(), OguryChoiceManager.TcfV2.Purpose.MEASURE_AD_PERFORMANCE).metaData;
                    if (bundle != null) {
