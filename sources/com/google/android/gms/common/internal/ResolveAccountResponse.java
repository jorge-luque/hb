...
public class ResolveAccountResponse extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getConnectionResult", mo15196id = 3)
    private ConnectionResult zadi;
    @SafeParcelable.Field(getter = "getSaveDefaultAccount", mo15196id = 4)
    private boolean zagg;
    @SafeParcelable.VersionField(mo15202id = 1)
    private final int zalf;
    @SafeParcelable.Field(mo15196id = 2)
    private IBinder zanx;
    @SafeParcelable.Field(getter = "isFromCrossClientAuth", mo15196id = 5)
    private boolean zapc;

    @SafeParcelable.Constructor
    ResolveAccountResponse(@SafeParcelable.Param(mo15199id = 1) int i, @SafeParcelable.Param(mo15199id = 2) IBinder iBinder, @SafeParcelable.Param(mo15199id = 3) ConnectionResult connectionResult, @SafeParcelable.Param(mo15199id = 4) boolean z, @SafeParcelable.Param(mo15199id = 5) boolean z2) {
        this.zalf = i;
        this.zanx = iBinder;
