...
public class AuthAccountRequest extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(mo15196id = 6, type = "android.accounts.Account")
    private Account zax;

    @SafeParcelable.Constructor
    AuthAccountRequest(@SafeParcelable.Param(mo15199id = 1) int i, @SafeParcelable.Param(mo15199id = 2) IBinder iBinder, @SafeParcelable.Param(mo15199id = 3) Scope[] scopeArr, @SafeParcelable.Param(mo15199id = 4) Integer num, @SafeParcelable.Param(mo15199id = 5) Integer num2, @SafeParcelable.Param(mo15199id = 6) Account account) {
        this.zalf = i;
        this.zanx = iBinder;
        this.zany = scopeArr;
        this.zanz = num;
