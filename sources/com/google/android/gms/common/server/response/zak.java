...
public final class zak extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getSerializedDictionary", mo15196id = 2)
    private final ArrayList<zal> zaqw;
    @SafeParcelable.Field(getter = "getRootClassName", mo15196id = 3)
    private final String zaqx;

    @SafeParcelable.Constructor
    zak(@SafeParcelable.Param(mo15199id = 1) int i, @SafeParcelable.Param(mo15199id = 2) ArrayList<zal> arrayList, @SafeParcelable.Param(mo15199id = 3) String str) {
        this.zalf = i;
        this.zaqw = null;
