...
public final class zaa extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getStringToIntConverter", mo15196id = 2)
    private final StringToIntConverter zapl;

    @SafeParcelable.Constructor
    zaa(@SafeParcelable.Param(mo15199id = 1) int i, @SafeParcelable.Param(mo15199id = 2) StringToIntConverter stringToIntConverter) {
        this.zalf = i;
