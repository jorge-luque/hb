...
public class WorkSourceUtil {
    ...
    private static final Method zzia = zzw();
    private static final Method zzib = zzx();
    private static final Method zzic = zzy();
    private static final Method zzid = zzz();
    private static final Method zzie = zzaa();
    private static final Method zzif = zzab();
    private static final Method zzig = zzac();
    ...
    private static void zza(WorkSource workSource, int i, String str) {
        if (zzib != null) {
            ...
            try {
                zzib.invoke(workSource, new Object[]{Integer.valueOf(i), str});
            } catch (Exception e) {
