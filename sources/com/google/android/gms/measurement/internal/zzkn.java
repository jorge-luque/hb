...
public final class zzkn extends AbstractSafeParcelable {
    ...
    zzkn(@SafeParcelable.Param(mo15199id = 1) int i, @SafeParcelable.Param(mo15199id = 2) String str, @SafeParcelable.Param(mo15199id = 3) long j, @SafeParcelable.Param(mo15199id = 4) Long l, @SafeParcelable.Param(mo15199id = 5) Float f, @SafeParcelable.Param(mo15199id = 6) String str2, @SafeParcelable.Param(mo15199id = 7) String str3, @SafeParcelable.Param(mo15199id = 8) Double d) {
        this.zzg = i;
        this.zza = str;
        this.zzb = j;
        this.zzc = l;
