...
public class GeofencingRequest extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getParcelableGeofences", mo15196id = 1)
    private final List<zzbh> zzap;
    @SafeParcelable.Field(getter = "getInitialTrigger", mo15196id = 2)
    ...
    GeofencingRequest(@SafeParcelable.Param(mo15199id = 1) List<zzbh> list, @SafeParcelable.Param(mo15199id = 2) int i, @SafeParcelable.Param(mo15199id = 3) String str) {
        this.zzap = list;
        this.zzaq = i;
        this.tag = str;
    }
