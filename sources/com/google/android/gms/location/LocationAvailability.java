...
public final class LocationAvailability extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(defaultValueUnchecked = "LocationAvailability.STATUS_UNKNOWN", mo15196id = 1)
    @Deprecated
    private int zzar;
    @SafeParcelable.Field(defaultValueUnchecked = "LocationAvailability.STATUS_UNKNOWN", mo15196id = 2)
    @Deprecated
    private int zzas;
    @SafeParcelable.Field(defaultValueUnchecked = "0", mo15196id = 3)
    private long zzat;
    @SafeParcelable.Field(defaultValueUnchecked = "LocationAvailability.STATUS_UNSUCCESSFUL", mo15196id = 4)
    private int zzau;
    @SafeParcelable.Field(mo15196id = 5)
    private zzaj[] zzav;

    @SafeParcelable.Constructor
    LocationAvailability(@SafeParcelable.Param(mo15199id = 4) int i, @SafeParcelable.Param(mo15199id = 1) int i2, @SafeParcelable.Param(mo15199id = 2) int i3, @SafeParcelable.Param(mo15199id = 3) long j, @SafeParcelable.Param(mo15199id = 5) zzaj[] zzajArr) {
        this.zzau = i;
        this.zzar = i2;
        this.zzas = i3;
        this.zzat = j;
