...
public final class LocationSettingsResult extends AbstractSafeParcelable implements Result {
    ...
    @SafeParcelable.Field(getter = "getLocationSettingsStates", mo15196id = 2)
    ...
    public LocationSettingsResult(@SafeParcelable.Param(mo15199id = 1) Status status, @SafeParcelable.Param(mo15199id = 2) LocationSettingsStates locationSettingsStates) {
        this.zzbl = status;
