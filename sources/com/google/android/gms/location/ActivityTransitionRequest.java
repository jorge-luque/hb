...
public class ActivityTransitionRequest extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getTag", mo15196id = 2)
    private final String tag;
    @SafeParcelable.Field(getter = "getActivityTransitions", mo15196id = 1)
    private final List<ActivityTransition> zzl;
    @SafeParcelable.Field(getter = "getClients", mo15196id = 3)
    ...
    public ActivityTransitionRequest(@SafeParcelable.Param(mo15199id = 1) List<ActivityTransition> list, @SafeParcelable.Param(mo15199id = 2) String str, @SafeParcelable.Param(mo15199id = 3) List<ClientIdentity> list2) {
