...
public class ActivityRecognitionResult extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    public ActivityRecognitionResult(@SafeParcelable.Param(mo15199id = 1) List<DetectedActivity> list, @SafeParcelable.Param(mo15199id = 2) long j, @SafeParcelable.Param(mo15199id = 3) long j2, @SafeParcelable.Param(mo15199id = 4) int i, @SafeParcelable.Param(mo15199id = 5) Bundle bundle) {
        boolean z = true;
