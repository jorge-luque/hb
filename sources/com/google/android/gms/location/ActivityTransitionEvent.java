...
public class ActivityTransitionEvent extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getActivityType", mo15196id = 1)
    private final int zzi;
    @SafeParcelable.Field(getter = "getTransitionType", mo15196id = 2)
    private final int zzj;
    @SafeParcelable.Field(getter = "getElapsedRealTimeNanos", mo15196id = 3)
    private final long zzk;

    @SafeParcelable.Constructor
    public ActivityTransitionEvent(@SafeParcelable.Param(mo15199id = 1) int i, @SafeParcelable.Param(mo15199id = 2) int i2, @SafeParcelable.Param(mo15199id = 3) long j) {
