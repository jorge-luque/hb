...
public final class LocationSettingsRequest extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getLocationRequests", mo15196id = 1)
    private final List<LocationRequest> zzbg;
    @SafeParcelable.Field(defaultValue = "false", getter = "alwaysShow", mo15196id = 2)
    private final boolean zzbh;
    @SafeParcelable.Field(getter = "needBle", mo15196id = 3)
    private final boolean zzbi;
    @SafeParcelable.Field(getter = "getConfiguration", mo15196id = 5)
    private zzae zzbj;
    ...
    LocationSettingsRequest(@SafeParcelable.Param(mo15199id = 1) List<LocationRequest> list, @SafeParcelable.Param(mo15199id = 2) boolean z, @SafeParcelable.Param(mo15199id = 3) boolean z2, @SafeParcelable.Param(mo15199id = 5) zzae zzae) {
        this.zzbg = list;
        this.zzbh = z;
        this.zzbi = z2;
        this.zzbj = zzae;
