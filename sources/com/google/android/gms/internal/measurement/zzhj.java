...
interface zzhj {
    ...
    <T> T zza(zzhi<T> zzhi, zzev zzev) throws IOException;

    void zza(List<Double> list) throws IOException;

    <T> void zza(List<T> list, zzhi<T> zzhi, zzev zzev) throws IOException;

    <K, V> void zza(Map<K, V> map, zzgk<K, V> zzgk, zzev zzev) throws IOException;

    int zzb();

    @Deprecated
    <T> T zzb(zzhi<T> zzhi, zzev zzev) throws IOException;

    void zzb(List<Float> list) throws IOException;

    @Deprecated
    <T> void zzb(List<T> list, zzhi<T> zzhi, zzev zzev) throws IOException;
    ...
    void zzk(List<zzdz> list) throws IOException;
