...
public final class zzarr {
    ...
    private final void zzv(Context context) {
        ...
        if (registerReceiver != null) {
            ...
            this.zzdqd = (double) (((float) registerReceiver.getIntExtra(AppLovinEventTypes.USER_COMPLETED_LEVEL, -1)) / ((float) registerReceiver.getIntExtra("scale", -1)));
    ...
    private static String zzw(Context context) {
        try {
            PackageInfo packageInfo = Wrappers.packageManager(context).getPackageInfo("com.android.vending", OguryChoiceManager.TcfV2.Purpose.MEASURE_AD_PERFORMANCE);
            if (packageInfo != null) {
                int i = packageInfo.versionCode;
