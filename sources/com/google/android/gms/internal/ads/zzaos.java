...
public final class zzaos extends zzapb {
    ...
    public final void execute() {
        ...
        if (TextUtils.isEmpty(str)) {
            ...
            zzar.setTitle(resources != null ? resources.getString(C3073R.string.f8629s1) : "Save image");
            zzar.setMessage(resources != null ? resources.getString(C3073R.string.f8630s2) : "Allow Ad to store image in Picture gallery?");
            zzar.setPositiveButton(resources != null ? resources.getString(C3073R.string.f8631s3) : C6078a.HEADER_ACCEPT, new zzaov(this, str, lastPathSegment));
            zzar.setNegativeButton(resources != null ? resources.getString(C3073R.string.f8632s4) : "Decline", new zzaou(this));
            zzar.create().show();
        }
    }
}
