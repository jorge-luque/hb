...
public final class zzazz extends AbstractSafeParcelable {
    ...
    zzazz(@SafeParcelable.Param(mo15199id = 2) String str, @SafeParcelable.Param(mo15199id = 3) int i, @SafeParcelable.Param(mo15199id = 4) int i2, @SafeParcelable.Param(mo15199id = 5) boolean z, @SafeParcelable.Param(mo15199id = 6) boolean z2) {
        this.zzbnd = str;
        this.zzdzn = i;
        this.zzdzo = i2;
        this.zzdzp = z;
