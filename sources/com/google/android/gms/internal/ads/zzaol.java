...
public final class zzaol implements MediationInterstitialAdapter {
    ...
    public final void showInterstitial() {
        ...
        a.f1619a.setData(this.uri);
        zzaxa.zzdwf.post(new zzaon(this, new AdOverlayInfoParcel(new zzd(a.f1619a), (zzub) null, new zzaok(this), (zzt) null, new zzazz(0, 0, false))));
        zzq.zzla().zzvx();
    }
}
