...
public final class zzcdn extends zzadr {
    ...
    public final List<String> getAvailableAssetNames() {
        C3204g<String, zzace> zzale = this.zzfqb.zzale();
        C3204g<String, String> zzalg = this.zzfqb.zzalg();
        String[] strArr = new String[(zzale.size() + zzalg.size())];
        int i = 0;
        int i2 = 0;
        int i3 = 0;
        while (i2 < zzale.size()) {
            strArr[i3] = zzale.mo18803b(i2);
            i2++;
            i3++;
        }
        while (i < zzalg.size()) {
            strArr[i3] = zzalg.mo18803b(i);
            i++;
            i3++;
        }
    ...
    public final boolean zzsg() {
        ...
        zzazw.zzfc("Trying to start OMID session before creation.");
        return false;
    }
    ...
    public final void zzsh() {
        ...
        if ("Google".equals(zzalf)) {
            zzazw.zzfc("Illegal argument specified for omid partner name.");
            return;
        }
        zzbzm zzbzm = this.zzftd;
        if (zzbzm != null) {
