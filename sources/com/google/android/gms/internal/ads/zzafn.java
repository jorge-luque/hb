...
public final class zzafn {
                ...
                for (int i = 0; i < jSONArray.length(); i++) {
                    try {
                        ...
                        try {
                            ...
                            zzazw.zzc("Error constructing openable urls response.", e2);
                        }
                    } catch (JSONException e3) {
                        zzazw.zzc("Error parsing the intent data.", e3);
                    }
                }
    ...
    static final /* synthetic */ void zza(zzaif zzaif, Map map) {
        ...
        try {
            ...
            zzazw.zzfc(valueOf.length() != 0 ? "Unable to append parameter to URL: ".concat(valueOf) : new String("Unable to append parameter to URL: "));
        }
