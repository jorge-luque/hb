...
public final class zzcgg implements zzegz<zzst> {
    ...
    private final zzehm<zztf.zza.C6840zza> zzfic;
    private final zzehm<String> zzfmo;
    private final zzehm<zzazz> zzfnd;
    private final zzehm<String> zzfxx;

    private zzcgg(zzehm<Context> zzehm, zzehm<String> zzehm2, zzehm<zzazz> zzehm3, zzehm<zztf.zza.C6840zza> zzehm4, zzehm<String> zzehm5) {
        this.zzenp = zzehm;
        this.zzfmo = zzehm2;
        this.zzfnd = zzehm3;
        this.zzfic = zzehm4;
    ...
    public static zzcgg zze(zzehm<Context> zzehm, zzehm<String> zzehm2, zzehm<zzazz> zzehm3, zzehm<zztf.zza.C6840zza> zzehm4, zzehm<String> zzehm5) {
    ...
    public final /* synthetic */ Object get() {
        ...
        zztf.zza.C6840zza zza = this.zzfic.get();
