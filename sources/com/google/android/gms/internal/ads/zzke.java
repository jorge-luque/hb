...
final class zzke implements zzjz {
    ...
    /* synthetic */ zzke(zzkc zzkc, zzkb zzkb) {
        this(zzkc);
    }
    ...
    public final void zza(int i, int i2, zzjl zzjl) throws IOException, InterruptedException {
        this.zzaru.zza(i, i2, zzjl);
    }
}
