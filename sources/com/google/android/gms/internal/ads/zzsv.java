...
public final class zzsv {
    ...
    public static final class zza extends zzecd<zza, zzb> implements zzedq {
        ...
        /* compiled from: com.google.android.gms:play-services-ads@@19.1.0 */
        public enum C6839zza implements zzecf {
            ...
            BANNER_SIZE_INVALID(C6078a.DEFAULT_TIMEOUT),
            ...
            private static final zzeci<C6839zza> zzeh = null;
            ...
            private C6839zza(int i) {
                this.value = i;
            }

            public final String toString() {
                return "<" + C6839zza.class.getName() + '@' + Integer.toHexString(System.identityHashCode(this)) + " number=" + this.value + " name=" + name() + '>';
            }
        ...
        public final Object zza(int i, Object obj, Object obj2) {
            switch (zzsx.zzdk[i - 1]) {
                ...
                case 3:
                    return zzecd.zza((zzedo) zzbth, "\u0001\u0000", (Object[]) null);
                case 4:
                    return zzbth;
                case 5:
