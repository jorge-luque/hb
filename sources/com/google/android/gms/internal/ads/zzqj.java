...
public final class zzqj {
    ...
    public final String toString() {
        ...
        StringBuilder sb = new StringBuilder(String.valueOf(zza).length() + AdMostAdListener.CLICKED + String.valueOf(zza2).length() + String.valueOf(str).length() + String.valueOf(str2).length() + String.valueOf(str3).length());
