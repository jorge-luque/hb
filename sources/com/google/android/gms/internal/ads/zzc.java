...
public final class zzc extends Thread {
    ...
    public final void run() {
        if (DEBUG) {
            zzag.m12270v("start new dispatcher", new Object[0]);
        }
        ...
        while (true) {
            try {
                ...
                zzag.m12269e("Ignoring spurious interrupt of CacheDispatcher thread; use quit() to terminate it", new Object[0]);
            }
        }
    }
}
