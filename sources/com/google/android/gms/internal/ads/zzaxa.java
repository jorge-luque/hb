...
public final class zzaxa {
    ...
    public static boolean zzay(Context context) {
        try {
            ...
            zzazw.zzc("Error loading class.", th);
    ...
    private static Bitmap zzo(View view) {
        try {
            ...
            zzazw.zzfc("Width or height of view is zero");
            return null;
        } catch (RuntimeException e) {
            zzazw.zzc("Fail to capture the webview", e);
            return null;
        }
    }
    ...
    private static Bitmap zzp(View view) {
        ...
        try {
            ...
            zzazw.zzc("Fail to capture the web view", e);
        }
        return bitmap;
    }
    ...
    public static String zzs(Context context, String str) {
        try {
            return new String(IOUtils.readInputStreamFully(context.openFileInput(str), true), C4250c.DEFAULT_CHARSET);
        } catch (IOException unused) {
            zzazw.zzed("Error reading from internal storage.");
            return "";
        }
    }
    ...
    public static String zzxj() {
        ...
        return resources != null ? resources.getString(C3073R.string.f8635s7) : "Test Ad";
    }
    ...
    public final void zza(Context context, String str, boolean z, HttpURLConnection httpURLConnection) {
        ...
        httpURLConnection.setRequestProperty(C6078a.HEADER_USER_AGENT, zzr(context, str));
    ...
    public final java.lang.String zzr(android.content.Context r5, java.lang.String r6) {
        ...
        L_0x0061:
            com.google.android.gms.internal.ads.zzazw.zzfc(r1)     // Catch:{ all -> 0x00cd }
            goto L_0x003b
        L_0x0065:
    ...
    public static void zzc(Context context, String str, String str2) {
        try {
            ...
            openFileOutput.write(str2.getBytes(C4250c.DEFAULT_CHARSET));
            openFileOutput.close();
        } catch (Exception e) {
            zzazw.zzc("Error writing to file in internal storage.", e);
        }
    }
        ...
        if (!zzabj.zzcwk.get().booleanValue()) {
            ...
            while (i < length) {
                ...
                if (charAt == '%') {
                    ...
                    try {
                        sb3.append(new String(bArr, 0, i2, C4250c.DEFAULT_CHARSET));
    ...
    public static WebResourceResponse zzd(Context context, String str, String str2) {
        try {
            HashMap hashMap = new HashMap();
            hashMap.put(C6078a.HEADER_USER_AGENT, zzq.zzkw().zzr(context, str));
            hashMap.put("Cache-Control", "max-stale=3600");
            String str3 = new zzaym(context).zzc(str2, hashMap).get(60, TimeUnit.SECONDS);
            if (str3 != null) {
                return new WebResourceResponse("application/javascript", C4250c.DEFAULT_CHARSET, new ByteArrayInputStream(str3.getBytes(C4250c.DEFAULT_CHARSET)));
            }
            return null;
        } catch (IOException | InterruptedException | ExecutionException | TimeoutException e) {
            zzazw.zzd("Could not fetch MRAID JS.", e);
            return null;
        }
    }
    ...
    public final JSONObject zza(Bundle bundle, JSONObject jSONObject) {
        if (bundle != null) {
            try {
                ...
                zzazw.zzc("Error converting Bundle to JSON", e);
            }
        }
        return null;
    }
    ...
    public final void zza(Context context, String str, String str2, Bundle bundle, boolean z) {
        zzq.zzkw();
        bundle.putString(TapjoyConstants.TJC_NOTIFICATION_DEVICE_PREFIX, zzxh());
    ...
    public static void zza(Context context, Uri uri) {
        try {
            ...
            zzazw.zzc("No browser is found.", e);
        }
    }
