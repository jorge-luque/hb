...
final class zzkj {
    ...
    private static final int zzavr = zzov.zzbj(ViewHierarchyConstants.TEXT_KEY);
    ...
    private static Pair<String, byte[]> zzb(zzos zzos, int i) {
        ...
        if ((readUnsignedByte & OguryChoiceManager.TcfV2.Purpose.MEASURE_AD_PERFORMANCE) != 0) {
            zzos.zzbj(2);
        }
    ...
    private static int zzc(zzos zzos) {
        ...
        while ((readUnsignedByte & OguryChoiceManager.TcfV2.Purpose.MEASURE_AD_PERFORMANCE) == 128) {
    ...
    public static zzkz zza(zzkx zzkx, zzkh zzkh, zzjq zzjq) throws zzhi {
        ...
        if (!(zzkl.zzgy() && "audio/raw".equals(zzkx3.zzahd.zzagi) && zzje == 0 && i == 0 && i2 == 0)) {
            ...
            int zzgx = zzkl4.zzgx();
            long j5 = (long) zzje3;
            int i33 = Utility.DEFAULT_STREAM_BUFFER_SIZE / zzgx;
            int i34 = 0;
        ...
        while (true) {
            ...
            if (j10 != j2) {
                ...
                while (zzb3 < zzb4) {
                    ...
                    int[] iArr19 = iArr4;
                    long j13 = j10;
                    jArr16[i54] = zzov.zza(j3, 1000000, zzkx2.zzayf) + zzov.zza(jArr[zzb3] - j10, 1000000, zzkx2.zzcv);
                    if (z5 && iArr3[i54] > i56) {
                        i56 = iArr19[zzb3];
                    }
                    i54++;
        ...
        if (z6) {
            return new zzkz(jArr19, iArr21, i52, jArr16, iArr22);
        }
