    ...
    private static void zza(HttpURLConnection httpURLConnection, zzq<?> zzq) throws IOException, zzb {
        ...
        if (zzg != null) {
            ...
            if (!httpURLConnection.getRequestProperties().containsKey("Content-Type")) {
                httpURLConnection.setRequestProperty("Content-Type", C4250c.DEFAULT_CHARSET.length() != 0 ? "application/x-www-form-urlencoded; charset=".concat(C4250c.DEFAULT_CHARSET) : new String("application/x-www-form-urlencoded; charset="));
            }
