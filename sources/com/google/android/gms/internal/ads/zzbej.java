...
public class zzbej extends WebViewClient implements zzbfw {
    ...
    private final WebResourceResponse zze(String str, Map<String, String> map) throws IOException {
        ...
        while (true) {
            ...
            if (i <= 20) {
                ...
                openConnection.setConnectTimeout(C6078a.DEFAULT_TIMEOUT);
                openConnection.setReadTimeout(C6078a.DEFAULT_TIMEOUT);
                ...
                if (openConnection instanceof HttpURLConnection) {
                    ...
                    if (responseCode < 300 || responseCode >= 400) {
                        ...
                        if (headerField == null) {
                            ...
                            if (protocol == null) {
                                zzazw.zzfc("Protocol is null");
                                return zzaba();
                            } else if (protocol.equals("http") || protocol.equals("https")) {
                                String valueOf = String.valueOf(headerField);
                                zzazw.zzed(valueOf.length() != 0 ? "Redirecting to ".concat(valueOf) : new String("Redirecting to "));
                                httpURLConnection.disconnect();
                                url = url2;
                            } else {
                                String valueOf2 = String.valueOf(protocol);
                                zzazw.zzfc(valueOf2.length() != 0 ? "Unsupported scheme: ".concat(valueOf2) : new String("Unsupported scheme: "));
                                return zzaba();
                            }
                        }
                    }
        ...
        if (!"gmsg".equalsIgnoreCase(parse.getScheme()) || !"mobileads.google.com".equalsIgnoreCase(parse.getHost())) {
            ...
            if (!this.zzehs.getWebView().willNotDraw()) {
                try {
                    ...
                    zzazw.zzfc(valueOf2.length() != 0 ? "Unable to append parameter to URL: ".concat(valueOf2) : new String("Unable to append parameter to URL: "));
                }
                zzc zzc = this.zzdas;
                ...
                zzazw.zzfc(valueOf3.length() != 0 ? "AdWebView unable to handle URL: ".concat(valueOf3) : new String("AdWebView unable to handle URL: "));
            }
        } else {
            zzh(parse);
        }
    ...
    public final void zzaay() {
        ...
        if (zzst != null) {
            zzst.zza(zzsv.zza.C6839zza.DELAY_PAGE_LOAD_CANCELLED_AD);
        }
        this.zzeif = true;
        zzaaz();
    ...
    private final void zza(AdOverlayInfoParcel adOverlayInfoParcel) {
        ...
        if (this.zzeid != null) {
            ...
            if (str == null && (zzd = adOverlayInfoParcel.zzdks) != null) {
                str = zzd.url;
            }
            this.zzeid.zzdy(str);
        }
