...
final class zzdin implements zzdio {
    ...
    public final synchronized boolean zza(zzdiy zzdiy, zzdiv<?> zzdiv) {
        ...
        if (zzdiv != null) {
            zzdiv.zzgxt.zzaij().zzd((zztf.zzb) ((zzecd) zztf.zzb.zznf().zza(zztf.zzb.zza.zznh().zza(zztf.zzb.C6842zzb.IN_MEMORY).zza(zztf.zzb.zze.zznl().zzs(zzasx.zzgxd).zzt(zzasx.zzgxe).zzbx(zzaso.zzgym))).zzbet()));
        }
        dumpToLog();
        return zzb;
    }
    ...
    private final void zza(zzdiv<?> zzdiv, zzdjl zzdjl) {
        if (zzdiv != null) {
            zzdiv.zzgxt.zzaij().zzc((zztf.zzb) ((zzecd) zztf.zzb.zznf().zza(zztf.zzb.zza.zznh().zza(zztf.zzb.C6842zzb.IN_MEMORY).zza(zztf.zzb.zzd.zznj().zzq(zzdjl.zzgyl).zzbv(zzdjl.zzgym))).zzbet()));
        }
        dumpToLog();
    }
}
