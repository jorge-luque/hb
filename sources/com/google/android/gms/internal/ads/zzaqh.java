...
public final class zzaqh extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getAdViewAsBinder", mo15196id = 1, type = "android.os.IBinder")
    public final View zzaae;
    @SafeParcelable.Field(getter = "getAssetViewMapAsBinder", mo15196id = 2, type = "android.os.IBinder")
    public final Map<String, WeakReference<View>> zzdli;

    @SafeParcelable.Constructor
    public zzaqh(@SafeParcelable.Param(mo15199id = 1) IBinder iBinder, @SafeParcelable.Param(mo15199id = 2) IBinder iBinder2) {
