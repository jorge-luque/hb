...
final class zzdzu {
    ...
    static byte[] zze(byte[] bArr, byte[] bArr2) {
        ...
        if (bArr3.length == 32) {
            ...
            long zze = (((j39 << 26) | j33 | (j26 & j38)) & 4294967295L) + zze(bArr3, 16);
            long zze2 = (((j39 >> 6) | (j40 << 20)) & 4294967295L) + zze(bArr3, 20) + (zze >> 32);
            long zze3 = (((j40 >> 12) | (j41 << 14)) & 4294967295L) + zze(bArr3, 24) + (zze2 >> 32);
            byte[] bArr6 = new byte[16];
            zza(bArr6, zze & 4294967295L, 0);
            zza(bArr6, zze2 & 4294967295L, 4);
            zza(bArr6, zze3 & 4294967295L, 8);
            zza(bArr6, ((((j41 >> 18) | (j42 << 8)) & 4294967295L) + zze(bArr3, 28) + (zze3 >> 32)) & 4294967295L, 12);
            return bArr6;
        }
