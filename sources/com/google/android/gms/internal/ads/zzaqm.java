...
public final class zzaqm implements zzaqq {
    ...
    private final Uri.Builder zza(String str, String str2, String str3, int i) {
        ...
        return appendQueryParameter.appendQueryParameter(TapjoyConstants.TJC_NOTIFICATION_DEVICE_PREFIX, str6).appendQueryParameter("js", this.zzdls.zzbnd).appendQueryParameter("appid", str4).appendQueryParameter("exceptiontype", str).appendQueryParameter("stacktrace", str2).appendQueryParameter("eids", TextUtils.join(",", zzzz.zzra())).appendQueryParameter("exceptionkey", str3).appendQueryParameter("cl", "305933803").appendQueryParameter("rc", "dev").appendQueryParameter(TapjoyConstants.TJC_SESSION_ID, zzvj.zzpw()).appendQueryParameter("sampling_rate", Integer.toString(i)).appendQueryParameter("pb_tm", String.valueOf(zzabt.zzcxp.get()));
    }
}
