...
public final class zzcmy {
    ...
    zzcmy(Context context, zzbqc zzbqc, zzcmv zzcmv, zzcmp zzcmp) {
        ...
        this.zzgbg = zzcmv;
        this.zzgdu = zzcmp;
        this.zzgdt = (TelephonyManager) context.getSystemService(PlaceFields.PHONE);
    }

    /* access modifiers changed from: private */
    public final byte[] zza(boolean z, ArrayList<zztf.zzc.zza> arrayList, zztf.zzm zzm, zztf.zzo.zzc zzc) {
        boolean z2 = true;
        zztf.zzo.zza.C6843zza zzeu = zztf.zzo.zza.zzol().zzf((Iterable<? extends zztf.zzc.zza>) arrayList).zzh(zzbk(zzq.zzky().zzb(this.zzvf.getContentResolver()) != 0)).zzi(zzq.zzky().zza(this.zzvf, this.zzgdt)).zzev(this.zzgbg.zzaoy()).zzew(this.zzgbg.zzapa()).zzci(this.zzgbg.getResponseCode()).zzb(zzc).zzb(zzm).zzj(this.zzgdv).zzf(zzbk(z)).zzeu(zzq.zzld().currentTimeMillis());
    ...
    public static zztf.zzo.zzc zzl(Bundle bundle) {
        return zzgdw.get(zzdhj.zza(zzdhj.zza(bundle, TapjoyConstants.TJC_NOTIFICATION_DEVICE_PREFIX), AdMostExperimentManager.TYPE_NETWORK).getInt("active_network_state", -1), zztf.zzo.zzc.UNSPECIFIED);
    }
