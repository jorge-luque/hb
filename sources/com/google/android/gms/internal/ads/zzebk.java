    ...
    static class zza extends zzebk {
        ...
        public final void zzfi(long j) throws IOException {
            if (!zzebk.zzhui || zzbdy() < 10) {
                ...
                while ((j & -128) != 0) {
                    ...
                    this.position = i3 + 1;
                    zzefi.zza(bArr3, (long) i3, (byte) ((((int) j) & Notifications.NOTIFICATION_TYPES_ALL) | OguryChoiceManager.TcfV2.Purpose.MEASURE_AD_PERFORMANCE));
                    j >>>= 7;
                }
        ...
        public final void zzgh(int i) throws IOException {
            if (!zzebk.zzhui || zzean.zzbcl() || zzbdy() < 5) {
                ...
                this.position = i5 + 1;
                zzefi.zza(bArr4, (long) i5, (byte) (i | OguryChoiceManager.TcfV2.Purpose.MEASURE_AD_PERFORMANCE));
                int i6 = i >>> 7;
                if ((i6 & -128) == 0) {
                    byte[] bArr5 = this.buffer;
                ...
                this.position = i8 + 1;
                zzefi.zza(bArr6, (long) i8, (byte) (i6 | OguryChoiceManager.TcfV2.Purpose.MEASURE_AD_PERFORMANCE));
                int i9 = i6 >>> 7;
                if ((i9 & -128) == 0) {
                    byte[] bArr7 = this.buffer;
                ...
                this.position = i11 + 1;
                zzefi.zza(bArr8, (long) i11, (byte) (i9 | OguryChoiceManager.TcfV2.Purpose.MEASURE_AD_PERFORMANCE));
                int i12 = i9 >>> 7;
                if ((i12 & -128) == 0) {
                ...
                this.position = i14 + 1;
                zzefi.zza(bArr10, (long) i14, (byte) (i12 | OguryChoiceManager.TcfV2.Purpose.MEASURE_AD_PERFORMANCE));
