...
public final class zzlf {
    ...
    static {
        ...
        zzbal.put(20, 32);
        zzbal.put(21, 64);
        zzbal.put(22, OguryChoiceManager.TcfV2.Purpose.MEASURE_AD_PERFORMANCE);
        zzbal.put(30, 256);
        zzbal.put(31, 512);
        zzbal.put(32, OguryChoiceManager.TcfV2.Purpose.DEVELOP_AND_IMPROVE_PRODUCTS);
        zzbal.put(40, 2048);
        zzbal.put(41, CodedOutputStream.DEFAULT_BUFFER_SIZE);
        zzbal.put(42, Utility.DEFAULT_STREAM_BUFFER_SIZE);
        zzbal.put(50, 16384);
        zzbal.put(51, 32768);
        zzbal.put(52, 65536);
        ...
        zzbam.put("L90", 64);
        zzbam.put("L93", 256);
        zzbam.put("L120", Integer.valueOf(OguryChoiceManager.TcfV2.Purpose.DEVELOP_AND_IMPROVE_PRODUCTS));
        zzbam.put("L123", Integer.valueOf(CodedOutputStream.DEFAULT_BUFFER_SIZE));
        ...
        zzbam.put("H60", 8);
        zzbam.put("H63", 32);
        zzbam.put("H90", Integer.valueOf(OguryChoiceManager.TcfV2.Purpose.MEASURE_AD_PERFORMANCE));
        zzbam.put("H93", 512);
        zzbam.put("H120", 2048);
        zzbam.put("H123", Integer.valueOf(Utility.DEFAULT_STREAM_BUFFER_SIZE));
        zzbam.put("H150", 32768);
        zzbam.put("H153", Integer.valueOf(MetadataChangeSet.INDEXABLE_TEXT_SIZE_LIMIT_BYTES));
                    ...
                    if (i3 != 1 && i3 != 2) {
                        switch (i3) {
                            ...
                            case CodedOutputStream.DEFAULT_BUFFER_SIZE:
                                i4 = 2097152;
                                break;
                            case Utility.DEFAULT_STREAM_BUFFER_SIZE:
                                i4 = 2228224;
                                break;
                            case 16384:
                                i4 = 5652480;
