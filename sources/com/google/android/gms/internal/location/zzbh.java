...
public final class zzbh extends AbstractSafeParcelable implements Geofence {
    ...
    @SafeParcelable.Field(getter = "getRequestId", mo15196id = 1)
    private final String zzad;
    @SafeParcelable.Field(getter = "getTransitionTypes", mo15196id = 7)
    private final int zzae;
    @SafeParcelable.Field(getter = "getType", mo15196id = 3)
    private final short zzag;
    @SafeParcelable.Field(getter = "getLatitude", mo15196id = 4)
    private final double zzah;
    @SafeParcelable.Field(getter = "getLongitude", mo15196id = 5)
    private final double zzai;
    @SafeParcelable.Field(getter = "getRadius", mo15196id = 6)
    private final float zzaj;
    @SafeParcelable.Field(defaultValue = "0", getter = "getNotificationResponsiveness", mo15196id = 8)
    private final int zzak;
    @SafeParcelable.Field(defaultValue = "-1", getter = "getLoiteringDelay", mo15196id = 9)
    private final int zzal;
    @SafeParcelable.Field(getter = "getExpirationTime", mo15196id = 2)
    private final long zzdo;

    @SafeParcelable.Constructor
    public zzbh(@SafeParcelable.Param(mo15199id = 1) String str, @SafeParcelable.Param(mo15199id = 7) int i, @SafeParcelable.Param(mo15199id = 3) short s, @SafeParcelable.Param(mo15199id = 4) double d, @SafeParcelable.Param(mo15199id = 5) double d2, @SafeParcelable.Param(mo15199id = 6) float f, @SafeParcelable.Param(mo15199id = 2) long j, @SafeParcelable.Param(mo15199id = 8) int i2, @SafeParcelable.Param(mo15199id = 9) int i3) {
