...
public final class zzbd extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(defaultValueUnchecked = "null", mo15196id = 10)
    private String moduleId;
    @SafeParcelable.Field(defaultValueUnchecked = "null", mo15196id = 6)
    private String tag;
    @SafeParcelable.Field(defaultValueUnchecked = "null", mo15196id = 1)
    private LocationRequest zzdg;
    @SafeParcelable.Field(defaultValueUnchecked = "LocationRequestInternal.DEFAULT_HIDE_FROM_APP_OPS", mo15196id = 7)
    private boolean zzdh;
    @SafeParcelable.Field(defaultValueUnchecked = "LocationRequestInternal.DEFAULT_FORCE_COARSE_LOCATION", mo15196id = 8)
    private boolean zzdi;
    @SafeParcelable.Field(defaultValueUnchecked = "LocationRequestInternal.DEFAULT_EXEMPT_FROM_THROTTLE", mo15196id = 9)
    private boolean zzdj;
    private boolean zzdk = true;
    @SafeParcelable.Field(defaultValueUnchecked = "LocationRequestInternal.DEFAULT_CLIENTS", mo15196id = 5)
    private List<ClientIdentity> zzm;

    @SafeParcelable.Constructor
    zzbd(@SafeParcelable.Param(mo15199id = 1) LocationRequest locationRequest, @SafeParcelable.Param(mo15199id = 5) List<ClientIdentity> list, @SafeParcelable.Param(mo15199id = 6) String str, @SafeParcelable.Param(mo15199id = 7) boolean z, @SafeParcelable.Param(mo15199id = 8) boolean z2, @SafeParcelable.Param(mo15199id = 9) boolean z3, @SafeParcelable.Param(mo15199id = 10) String str2) {
