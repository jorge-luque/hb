...
public final class zzbf extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(defaultValueUnchecked = "null", mo15196id = 4)
    private PendingIntent zzbv;
    @SafeParcelable.Field(defaultValueUnchecked = "LocationRequestUpdateData.OPERATION_ADD", mo15196id = 1)
    private int zzcg;
    @SafeParcelable.Field(defaultValueUnchecked = "null", getter = "getFusedLocationProviderCallbackBinder", mo15196id = 6, type = "android.os.IBinder")
    private zzaj zzcj;
    @SafeParcelable.Field(defaultValueUnchecked = "null", mo15196id = 2)
    private zzbd zzdl;
    @SafeParcelable.Field(defaultValueUnchecked = "null", getter = "getLocationListenerBinder", mo15196id = 3, type = "android.os.IBinder")
    private zzx zzdm;
    @SafeParcelable.Field(defaultValueUnchecked = "null", getter = "getLocationCallbackBinder", mo15196id = 5, type = "android.os.IBinder")
    private zzu zzdn;

    @SafeParcelable.Constructor
    zzbf(@SafeParcelable.Param(mo15199id = 1) int i, @SafeParcelable.Param(mo15199id = 2) zzbd zzbd, @SafeParcelable.Param(mo15199id = 3) IBinder iBinder, @SafeParcelable.Param(mo15199id = 4) PendingIntent pendingIntent, @SafeParcelable.Param(mo15199id = 5) IBinder iBinder2, @SafeParcelable.Param(mo15199id = 6) IBinder iBinder3) {
        this.zzcg = i;
        this.zzdl = zzbd;
        zzaj zzaj = null;
