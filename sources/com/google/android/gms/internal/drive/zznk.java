...
final class zznk extends zznh {
    ...
    public final String zzg(byte[] bArr, int i, int i2) throws zzkq {
        if ((i | i2 | ((bArr.length - i) - i2)) >= 0) {
            ...
            int i4 = 0;
            while (r13 < i3) {
                byte zza = zznd.zza(bArr, (long) r13);
                if (!zzng.zzd(zza)) {
                    break;
                }
                i = r13 + 1;
            ...
            while (r13 < i3) {
                int i6 = r13 + 1;
                byte zza2 = zznd.zza(bArr, (long) r13);
                if (zzng.zzd(zza2)) {
                    int i7 = i5 + 1;
                    ...
                    if (i6 < i3 - 1) {
                        int i9 = i6 + 1;
                        int i10 = i9 + 1;
                        zzng.zza(zza2, zznd.zza(bArr, (long) i6), zznd.zza(bArr, (long) i9), cArr, i5);
                        r13 = i10;
                        i5++;
                    } else {
                        throw zzkq.zzdn();
                    ...
                    int i12 = i11 + 1;
                    zzng.zza(zza2, zza4, zznd.zza(bArr, (long) i11), zznd.zza(bArr, (long) i12), cArr, i5);
                    r13 = i12 + 1;
                    i5 = i5 + 1 + 1;
                } else {
                    throw zzkq.zzdn();
