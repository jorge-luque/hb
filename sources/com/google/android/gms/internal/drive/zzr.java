...
public final class zzr extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(defaultValueUnchecked = "com.google.android.gms.drive.DriveFile.MODE_WRITE_ONLY", mo15196id = 2)
    private final int mode;

    @SafeParcelable.Constructor
    public zzr(@SafeParcelable.Param(mo15199id = 2) int i) {
