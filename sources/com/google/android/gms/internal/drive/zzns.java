...
interface zzns {
    ...
    void zza(int i, zzjc zzjc) throws IOException;

    <K, V> void zza(int i, zzlj<K, V> zzlj, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    void zza(int i, Object obj, zzmf zzmf) throws IOException;

    void zza(int i, String str) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzmf zzmf) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zzmf zzmf) throws IOException;

    void zzb(int i, List<zzjc> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, zzmf zzmf) throws IOException;
