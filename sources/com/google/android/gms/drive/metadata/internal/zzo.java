...
public final class zzo extends zzl<DriveId> implements SearchableCollectionMetadataField<DriveId> {
    ...
    public final Collection<DriveId> zzd(DataHolder dataHolder, int i, int i2) {
                    ...
                    if (dataHolder3 != null) {
                        try {
                            ...
                            for (int i4 = 0; i4 < count2; i4++) {
                                ...
                                ((ParentDriveIdSet) hashMap.get(Long.valueOf(dataHolder3.getLong(string, i4, windowIndex2)))).zzjj.add(new zzq(dataHolder3.getString(string3, i4, windowIndex2), dataHolder3.getLong(string2, i4, windowIndex2), 1));
                            }
        ...
        for (zzq next : ((ParentDriveIdSet) parcelableArrayList.get(i)).zzjj) {
            hashSet.add(new DriveId(next.zzad, next.zzae, j, next.zzaf));
        }
        return hashSet;
    }
