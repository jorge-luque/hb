...
public final class IdToken extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(getter = "getIdToken", mo15196id = 2)
    private final String zzak;
    @SafeParcelable.Field(getter = "getAccountType", mo15196id = 1)
    private final String zzr;

    @SafeParcelable.Constructor
    public IdToken(@SafeParcelable.Param(mo15199id = 1) String str, @SafeParcelable.Param(mo15199id = 2) String str2) {
