...
public final class CredentialRequest extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getAccountTypes", mo15196id = 2)
    private final String[] zzaa;
    @SafeParcelable.Field(getter = "getCredentialPickerConfig", mo15196id = 3)
    private final CredentialPickerConfig zzab;
    @SafeParcelable.Field(getter = "getCredentialHintPickerConfig", mo15196id = 4)
    ...
    @SafeParcelable.Field(getter = "getRequireUserMediation", mo15196id = 8)
    private final boolean zzag;
    @SafeParcelable.Field(mo15196id = 1000)
    private final int zzu;
    @SafeParcelable.Field(getter = "isPasswordLoginSupported", mo15196id = 1)
    ...
    CredentialRequest(@SafeParcelable.Param(mo15199id = 1000) int i, @SafeParcelable.Param(mo15199id = 1) boolean z, @SafeParcelable.Param(mo15199id = 2) String[] strArr, @SafeParcelable.Param(mo15199id = 3) CredentialPickerConfig credentialPickerConfig, @SafeParcelable.Param(mo15199id = 4) CredentialPickerConfig credentialPickerConfig2, @SafeParcelable.Param(mo15199id = 5) boolean z2, @SafeParcelable.Param(mo15199id = 6) String str, @SafeParcelable.Param(mo15199id = 7) String str2, @SafeParcelable.Param(mo15199id = 8) boolean z3) {
        this.zzu = i;
        this.zzz = z;
