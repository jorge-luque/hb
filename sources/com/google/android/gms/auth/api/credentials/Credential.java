...
public class Credential extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(getter = "getId", mo15196id = 1)
    @Nonnull
    ...
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "getProfilePictureUri", mo15196id = 3)
    public final Uri zzo;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "getIdTokens", mo15196id = 4)
    @Nonnull
    public final List<IdToken> zzp;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "getPassword", mo15196id = 5)
    public final String zzq;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "getAccountType", mo15196id = 6)
    public final String zzr;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "getGivenName", mo15196id = 9)
    public final String zzs;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "getFamilyName", mo15196id = 10)
    public final String zzt;

    @SafeParcelable.Constructor
    Credential(@SafeParcelable.Param(mo15199id = 1) String str, @SafeParcelable.Param(mo15199id = 2) String str2, @SafeParcelable.Param(mo15199id = 3) Uri uri, @SafeParcelable.Param(mo15199id = 4) List<IdToken> list, @SafeParcelable.Param(mo15199id = 5) String str3, @SafeParcelable.Param(mo15199id = 6) String str4, @SafeParcelable.Param(mo15199id = 9) String str5, @SafeParcelable.Param(mo15199id = 10) String str6) {
        List<IdToken> list2;
