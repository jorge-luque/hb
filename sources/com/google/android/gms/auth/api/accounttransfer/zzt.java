...
public class zzt extends zzaz {
    ...
    @SafeParcelable.Field(getter = "getAccountType", mo15196id = 2)
    private String zzbn;
    @SafeParcelable.Field(getter = "getStatus", mo15196id = 3)
    private int zzbo;
    @SafeParcelable.Field(getter = "getTransferBytes", mo15196id = 4)
    private byte[] zzbp;
    @SafeParcelable.Field(getter = "getPendingIntent", mo15196id = 5)
    private PendingIntent zzbq;
    @SafeParcelable.Field(getter = "getDeviceMetaData", mo15196id = 6)
    ...
    zzt(@SafeParcelable.Indicator Set<Integer> set, @SafeParcelable.Param(mo15199id = 1) int i, @SafeParcelable.Param(mo15199id = 2) String str, @SafeParcelable.Param(mo15199id = 3) int i2, @SafeParcelable.Param(mo15199id = 4) byte[] bArr, @SafeParcelable.Param(mo15199id = 5) PendingIntent pendingIntent, @SafeParcelable.Param(mo15199id = 6) DeviceMetaData deviceMetaData) {
        this.zzba = set;
        this.zzv = i;
        this.zzbn = str;
        this.zzbo = i2;
