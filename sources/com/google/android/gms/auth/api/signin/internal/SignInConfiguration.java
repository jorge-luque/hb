...
public final class SignInConfiguration extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(getter = "getConsumerPkgName", mo15196id = 2)
    private final String zzbr;
    @SafeParcelable.Field(getter = "getGoogleConfig", mo15196id = 5)
    private GoogleSignInOptions zzbs;

    @SafeParcelable.Constructor
    public SignInConfiguration(@SafeParcelable.Param(mo15199id = 2) String str, @SafeParcelable.Param(mo15199id = 5) GoogleSignInOptions googleSignInOptions) {
