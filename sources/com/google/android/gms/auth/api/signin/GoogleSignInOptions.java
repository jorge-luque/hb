...
public class GoogleSignInOptions extends AbstractSafeParcelable implements Api.ApiOptions.Optional, ReflectedParcelable {
    ...
    @SafeParcelable.Field(getter = "isForceCodeForRefreshToken", mo15196id = 6)
    public final boolean zaaa;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "getServerClientId", mo15196id = 7)
    public String zaab;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "getHostedDomain", mo15196id = 8)
    public String zaac;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "getExtensions", mo15196id = 9)
    ...
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "getScopes", mo15196id = 2)
    public final ArrayList<Scope> zaw;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "getAccount", mo15196id = 3)
    public Account zax;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "isIdTokenRequested", mo15196id = 4)
    public boolean zay;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "isServerAuthCodeRequested", mo15196id = 5)
    ...
    GoogleSignInOptions(@SafeParcelable.Param(mo15199id = 1) int i, @SafeParcelable.Param(mo15199id = 2) ArrayList<Scope> arrayList, @SafeParcelable.Param(mo15199id = 3) Account account, @SafeParcelable.Param(mo15199id = 4) boolean z, @SafeParcelable.Param(mo15199id = 5) boolean z2, @SafeParcelable.Param(mo15199id = 6) boolean z3, @SafeParcelable.Param(mo15199id = 7) String str, @SafeParcelable.Param(mo15199id = 8) String str2, @SafeParcelable.Param(mo15199id = 9) ArrayList<GoogleSignInOptionsExtensionParcelable> arrayList2) {
