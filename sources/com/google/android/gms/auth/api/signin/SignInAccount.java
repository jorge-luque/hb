...
public class SignInAccount extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(defaultValue = "", mo15196id = 4)
    @Deprecated
    private String zzba;
    @SafeParcelable.Field(getter = "getGoogleSignInAccount", mo15196id = 7)
    private GoogleSignInAccount zzbb;
    @SafeParcelable.Field(defaultValue = "", mo15196id = 8)
    @Deprecated
    private String zzbc;

    @SafeParcelable.Constructor
    SignInAccount(@SafeParcelable.Param(mo15199id = 4) String str, @SafeParcelable.Param(mo15199id = 7) GoogleSignInAccount googleSignInAccount, @SafeParcelable.Param(mo15199id = 8) String str2) {
