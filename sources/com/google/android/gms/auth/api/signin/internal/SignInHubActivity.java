...
@KeepName
public class SignInHubActivity extends C0911c {
    ...
    private class zzc implements C0988a.C0989a<Void> {
        private zzc() {
        }

        public final C0997b<Void> onCreateLoader(int i, Bundle bundle) {
            return new zze(SignInHubActivity.this, GoogleApiClient.getAllClients());
        }

        public final /* synthetic */ void onLoadFinished(C0997b bVar, Object obj) {
            SignInHubActivity signInHubActivity = SignInHubActivity.this;
            signInHubActivity.setResult(signInHubActivity.zzbx, SignInHubActivity.this.zzby);
            SignInHubActivity.this.finish();
        }

        public final void onLoaderReset(C0997b<Void> bVar) {
        }
    }
    ...
    private final void zzn() {
        getSupportLoaderManager().mo5021a(0, (Bundle) null, new zzc());
        zzbt = false;
    }
