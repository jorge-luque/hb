...
public class TokenData extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(getter = "getGrantedScopes", mo15196id = 6)
    private final List<String> zzaa;
    @SafeParcelable.Field(getter = "getScopeData", mo15196id = 7)
    private final String zzab;
    @SafeParcelable.VersionField(mo15202id = 1)
    private final int zzv;
    @SafeParcelable.Field(getter = "getToken", mo15196id = 2)
    private final String zzw;
    @SafeParcelable.Field(getter = "getExpirationTimeSecs", mo15196id = 3)
    private final Long zzx;
    @SafeParcelable.Field(getter = "isCached", mo15196id = 4)
    private final boolean zzy;
    @SafeParcelable.Field(getter = "isSnowballed", mo15196id = 5)
    private final boolean zzz;

    @SafeParcelable.Constructor
    TokenData(@SafeParcelable.Param(mo15199id = 1) int i, @SafeParcelable.Param(mo15199id = 2) String str, @SafeParcelable.Param(mo15199id = 3) Long l, @SafeParcelable.Param(mo15199id = 4) boolean z, @SafeParcelable.Param(mo15199id = 5) boolean z2, @SafeParcelable.Param(mo15199id = 6) List<String> list, @SafeParcelable.Param(mo15199id = 7) String str2) {
        this.zzv = i;
