...
public final class zah extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getResolveAccountRequest", mo15196id = 2)
    private final ResolveAccountRequest zasd;

    @SafeParcelable.Constructor
    zah(@SafeParcelable.Param(mo15199id = 1) int i, @SafeParcelable.Param(mo15199id = 2) ResolveAccountRequest resolveAccountRequest) {
        this.zalf = i;
