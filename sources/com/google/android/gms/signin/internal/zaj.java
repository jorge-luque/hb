...
public final class zaj extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getConnectionResult", mo15196id = 2)
    private final ConnectionResult zadi;
    @SafeParcelable.VersionField(mo15202id = 1)
    private final int zalf;
    @SafeParcelable.Field(getter = "getResolveAccountResponse", mo15196id = 3)
    private final ResolveAccountResponse zase;

    @SafeParcelable.Constructor
    zaj(@SafeParcelable.Param(mo15199id = 1) int i, @SafeParcelable.Param(mo15199id = 2) ConnectionResult connectionResult, @SafeParcelable.Param(mo15199id = 3) ResolveAccountResponse resolveAccountResponse) {
        this.zalf = i;
