...
public final class zzd extends AbstractSafeParcelable {
    ...
    public zzd(@SafeParcelable.Param(mo15199id = 2) String str, @SafeParcelable.Param(mo15199id = 3) String str2, @SafeParcelable.Param(mo15199id = 4) String str3, @SafeParcelable.Param(mo15199id = 5) String str4, @SafeParcelable.Param(mo15199id = 6) String str5, @SafeParcelable.Param(mo15199id = 7) String str6, @SafeParcelable.Param(mo15199id = 8) String str7, @SafeParcelable.Param(mo15199id = 9) Intent intent2) {
        this.zzdkh = str;
        this.url = str2;
        this.mimeType = str3;
