...
public final class C4103f extends C4111n {
    /* renamed from: b */
    private static String m13715b(String str) {
    ...
    public boolean[] mo28376a(String str) {
        ...
        if (length <= 80) {
            ...
            for (int i3 = 0; i3 < length; i3++) {
                m13714a(C4102e.f11014a["0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ-. $/+%".indexOf(str.charAt(i3))], iArr);
            ...
            m13714a(148, iArr);
            int a = C4111n.m13729a(zArr, 0, iArr, true);
            int[] iArr2 = {1};
            int a2 = a + C4111n.m13729a(zArr, a, iArr2, false);
            for (int i5 = 0; i5 < length; i5++) {
                m13714a(C4102e.f11014a["0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ-. $/+%".indexOf(str.charAt(i5))], iArr);
                int a3 = a2 + C4111n.m13729a(zArr, a2, iArr, true);
                a2 = a3 + C4111n.m13729a(zArr, a3, iArr2, false);
            }
            m13714a(148, iArr);
            C4111n.m13729a(zArr, a2, iArr, true);
            return zArr;
        }
    ...
    /* renamed from: a */
    private static void m13714a(int i, int[] iArr) {
