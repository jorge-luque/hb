...
final class CodedOutputStream implements Flushable {
    ...
    public void writeRawVarint32(int i) throws IOException {
        while ((i & -128) != 0) {
            writeRawByte((i & Notifications.NOTIFICATION_TYPES_ALL) | OguryChoiceManager.TcfV2.Purpose.MEASURE_AD_PERFORMANCE);
            i >>>= 7;
        }
        writeRawByte(i);
    }
    ...
    public void writeRawVarint64(long j) throws IOException {
        while ((-128 & j) != 0) {
            writeRawByte((((int) j) & Notifications.NOTIFICATION_TYPES_ALL) | OguryChoiceManager.TcfV2.Purpose.MEASURE_AD_PERFORMANCE);
            j >>>= 7;
        }
        writeRawByte((int) j);
    }
