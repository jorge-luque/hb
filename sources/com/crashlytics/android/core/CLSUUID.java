...
class CLSUUID {
    ...
    public CLSUUID(C6107s sVar) {
        byte[] bArr = new byte[10];
        populateTime(bArr);
        populateSequenceNumber(bArr);
        populatePID(bArr);
        String c = C6090i.m19745c(sVar.mo34192d());
        String a = C6090i.m19727a(bArr);
        _clsId = String.format(Locale.US, "%s-%s-%s-%s", new Object[]{a.substring(0, 12), a.substring(12, 16), a.subSequence(16, 20), c.substring(0, 12)}).toUpperCase(Locale.US);
    }
