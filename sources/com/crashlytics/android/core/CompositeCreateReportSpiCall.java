...
class CompositeCreateReportSpiCall implements CreateReportSpiCall {
    ...
    static /* synthetic */ class C22581 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = $SwitchMap$com$crashlytics$android$core$Report$Type     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.crashlytics.android.core.CompositeCreateReportSpiCall.C22581.<clinit>():void");
        }
    }
    ...
    public boolean invoke(CreateReportRequest createReportRequest) {
        int i = C22581.$SwitchMap$com$crashlytics$android$core$Report$Type[createReportRequest.report.getType().ordinal()];
        if (i == 1) {
