...
class AppData {
    ...
    public static AppData create(Context context, C6107s sVar, String str, String str2) throws PackageManager.NameNotFoundException {
        ...
        return new AppData(str, str2, f, packageName2, num, str3);
    }
}
