...
class SessionProtobufHelper {
    ...
    private static final ByteString UNITY_PLATFORM_BYTE_STRING = ByteString.copyFromUtf8(AdColonyAppOptions.UNITY);
    ...
    private static int getDeviceIdentifierSize(C6107s.C6108a aVar, String str) {
        return CodedOutputStream.computeEnumSize(1, aVar.f16076a) + CodedOutputStream.computeBytesSize(2, ByteString.copyFromUtf8(str));
    }
    ...
    private static int getSessionDeviceSize(int i, ByteString byteString, int i2, long j, long j2, boolean z, Map<C6107s.C6108a, String> map, int i3, ByteString byteString2, ByteString byteString3) {
        int i4;
        int i5;
        int i6 = 0;
        ...
        if (map != null) {
            for (Map.Entry next : map.entrySet()) {
                int deviceIdentifierSize = getDeviceIdentifierSize((C6107s.C6108a) next.getKey(), (String) next.getValue());
    ...
    public static void writeSessionDevice(CodedOutputStream codedOutputStream, int i, String str, int i2, long j, long j2, boolean z, Map<C6107s.C6108a, String> map, int i3, String str2, String str3) throws Exception {
        ...
        for (Map.Entry next : map.entrySet()) {
            ...
            codedOutputStream2.writeRawVarint32(getDeviceIdentifierSize((C6107s.C6108a) next.getKey(), (String) next.getValue()));
            codedOutputStream2.writeEnum(1, ((C6107s.C6108a) next.getKey()).f16076a);
    ...
    public static void writeSessionEvent(CodedOutputStream codedOutputStream, long j, String str, TrimmedThrowableData trimmedThrowableData, Thread thread, StackTraceElement[] stackTraceElementArr, Thread[] threadArr, List<StackTraceElement[]> list, Map<String, String> map, LogFileManager logFileManager, ActivityManager.RunningAppProcessInfo runningAppProcessInfo, int i, String str2, String str3, Float f, int i2, boolean z, long j2, long j3) throws Exception {
        ...
        if (byteStringForLog == null) {
            C6059c.m19630f().mo34093d(CrashlyticsCore.TAG, "No log data to include with this event.");
        }
