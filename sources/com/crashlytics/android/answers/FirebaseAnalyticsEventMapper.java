...
public class FirebaseAnalyticsEventMapper {
    ...
    private String mapAttribute(String str) {
        ...
        String replaceAll = str.replaceAll("[^\\p{Alnum}_]+", C6120b.ROLL_OVER_FILE_NAME_SEPARATOR);
    ...
    private Bundle mapPredefinedEvent(SessionEvent sessionEvent) {
        ...
        if ("purchase".equals(sessionEvent.predefinedType)) {
            putString(bundle, IdColumns.COLUMN_IDENTIFIER, (String) sessionEvent.predefinedAttributes.get("itemId"));
            ...
            putDouble(bundle, AppMeasurementSdk.ConditionalUserProperty.VALUE, mapPriceValue(sessionEvent.predefinedAttributes.get("totalPrice")));
            putString(bundle, "currency", (String) sessionEvent.predefinedAttributes.get("currency"));
            ...
            putString(bundle, IdColumns.COLUMN_IDENTIFIER, (String) sessionEvent.predefinedAttributes.get("contentId"));
            putString(bundle, "item_name", (String) sessionEvent.predefinedAttributes.get("contentName"));
        } else if (AppLovinEventTypes.USER_EXECUTED_SEARCH.equals(sessionEvent.predefinedType)) {
            ...
            putString(bundle, "method", (String) sessionEvent.predefinedAttributes.get("method"));
        } else if (AppLovinEventTypes.USER_LOGGED_IN.equals(sessionEvent.predefinedType)) {
            putString(bundle, "method", (String) sessionEvent.predefinedAttributes.get("method"));
        } else if (AppLovinEventTypes.USER_SENT_INVITATION.equals(sessionEvent.predefinedType)) {
            putString(bundle, "method", (String) sessionEvent.predefinedAttributes.get("method"));
    ...
    public FirebaseAnalyticsEvent mapEvent(SessionEvent sessionEvent) {
        ...
        C6059c.m19630f().mo34093d(Answers.TAG, "Logging event into firebase...");
