...
import p118io.fabric.sdk.android.p200m.p203c.C6119a;

class SessionEventTransform implements C6119a<SessionEvent> {
    ...
    public byte[] toBytes(SessionEvent sessionEvent) throws IOException {
        return buildJsonForEvent(sessionEvent).toString().getBytes(C4250c.DEFAULT_CHARSET);
    }
}
