                    ...
                    try {
                        ...
                        try {
                            if (configuration.getWebViewUrl() != null) {
                                str = str + "&origin=" + URLEncoder.encode(configuration.getWebViewUrl(), C4250c.DEFAULT_CHARSET);
                            }
                        ...
                        try {
                            if (configuration.getWebViewVersion() != null) {
                                str = str + "&version=" + URLEncoder.encode(configuration.getWebViewVersion(), C4250c.DEFAULT_CHARSET);
                            }
                        } catch (UnsupportedEncodingException e2) {
                            DeviceLog.exception("Unsupported charset when encoding webview version", e2);
                        }
                        webViewApp.getWebView().loadDataWithBaseURL("file://" + SdkProperties.getLocalWebViewFile() + str, configuration.getWebViewData(), "text/html", C4250c.DEFAULT_CHARSET, (String) null);
