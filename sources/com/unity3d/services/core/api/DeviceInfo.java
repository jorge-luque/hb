...
public class DeviceInfo {
    ...
    static /* synthetic */ class C53472 {
        ...
        static {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.unity3d.services.core.api.DeviceInfo.C53472.<clinit>():void");
        }
    }
    ...
    private static File getFileForStorageType(StorageType storageType) {
        int i = C53472.$SwitchMap$com$unity3d$services$core$api$DeviceInfo$StorageType[storageType.ordinal()];
        if (i == 1) {
    ...
    public static void registerVolumeChangeListener(final Integer num, WebViewCallback webViewCallback) {
        ...
        if (_volumeChangeListeners.get(num.intValue()) == null) {
            C53461 r0 = new IVolumeChangeListener() {
